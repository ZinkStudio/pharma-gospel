 ...
 * This source code is licensed under the Apache-2.0 license found in the
 * LICENSE file in the root directory of this source tree.
 */let c=class extends n{render(){var e;let o={[`${i}--skeleton__placeholder`]:!0};if(this.optionalClasses){const n={};null===(e=this.optionalClasses)||void 0===e||e.split(" ").forEach((e=>{n[e]=!0})),o=Object.assign(Object.assign({},o),n)}const n=t(o);return s` <div class="${n}"></div> `}};c.styles=l,o([r({reflect:!0,attribute:"optional-classes"})],c.prototype,"optionalClasses",void 0),c=o([a(`${i}-skeleton-placeholder`)],c);
