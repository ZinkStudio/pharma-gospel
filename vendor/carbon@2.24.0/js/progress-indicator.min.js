 ...
 * This source code is licensed under the Apache-2.0 license found in the
 * LICENSE file in the root directory of this source tree.
 */let h=class extends s{constructor(){super(...arguments),this.vertical=!1,this.spaceEqually=!1}connectedCallback(){this.hasAttribute("role")||this.setAttribute("role","list"),super.connectedCallback()}updated(e){const o=!this.vertical&&this.spaceEqually;e.has("vertical")&&n(this.querySelectorAll(this.constructor.selectorStep),(e=>{e.vertical=this.vertical,e.spaceEqually=o})),e.has("spaceEqually")&&n(this.querySelectorAll(this.constructor.selectorStep),(e=>{e.spaceEqually=o}))}render(){return t`<slot></slot>`}static get selectorStep(){return`${r}-progress-step`}};h.styles=b,o([d({type:Boolean,reflect:!0})],h.prototype,"vertical",void 0),o([d({type:Boolean,reflect:!0,attribute:"space-equally"})],h.prototype,"spaceEqually",void 0),h=o([i(`${r}-progress-indicator`)],h);
/**
 * @license
 *
 * Copyright IBM Corp. 2019, 2023
 ...
 * LICENSE file in the root directory of this source tree.
 */
let f=class extends s{constructor(){super(...arguments),this.vertical=!1}updated(e){e.has("vertical")&&n(this.querySelectorAll(this.constructor.selectorStep),(e=>{e.vertical=this.vertical}))}render(){return t`<slot></slot>`}static get selectorStep(){return`${r}-progress-step-skeleton`}};f.styles=b,o([d({type:Boolean,reflect:!0})],f.prototype,"vertical",void 0),f=o([i(`${r}-progress-indicator-skeleton`)],f);
/**
 * @license
 *
 ...
 * LICENSE file in the root directory of this source tree.
 */
var u;!function(e){e.COMPLETE="complete",e.CURRENT="current",e.INCOMPLETE="incomplete",e.INVALID="invalid"}(u||(u={}));
/**
 * @license
 *
 ...
 * LICENSE file in the root directory of this source tree.
 */
const m={[u.COMPLETE]:a,[u.INCOMPLETE]:p,[u.INVALID]:({children:e,...o}={})=>c`<svg focusable="false" preserveAspectRatio="xMidYMid meet" xmlns="http://www.w3.org/2000/svg" fill="currentColor" ...="${v(o)}" aria-hidden="true" width="16" height="16" viewBox="0 0 16 16">${e}<path d="M8,1C4.1,1,1,4.1,1,8s3.1,7,7,7s7-3.1,7-7S11.9,1,8,1z M8,14c-3.3,0-6-2.7-6-6s2.7-6,6-6s6,2.7,6,6S11.3,14,8,14z"></path><path d="M7.5 4H8.5V9H7.5zM8 10.2c-.4 0-.8.3-.8.8s.3.8.8.8c.4 0 .8-.3.8-.8S8.4 10.2 8 10.2z"></path></svg>`,[u.CURRENT]:l};let y=class extends(g(s)){constructor(){super(...arguments),this.disabled=!1,this.state=u.INCOMPLETE,this.vertical=!1,this.spaceEqually=!1}connectedCallback(){this.hasAttribute("role")||this.setAttribute("role","listitem"),super.connectedCallback()}updated(e){e.has("disabled")&&this.setAttribute("aria-disabled",String(Boolean(this.disabled)))}render(){const{description:e,iconLabel:o,label:s,secondaryLabelText:d,secondaryLabel:n,state:i}=this,a=o||e,p=d||n;return t`
      <div class="${r}--progress-step-button" tabindex="0">
        ${m[i]({class:{[u.INVALID]:`${r}--progress__warning`}[i],children:a?c`<title>${a}</title>`:void 0})}
        <slot name="label-text">
          <p
            role="button"
            class="${r}--progress-label"
        ...
        <slot name="secondary-label-text">
          ${p?t`<p class="${r}--progress-optional">
                ${p}
              </p>`:void 0}
        </slot>
        <span class="${r}--progress-line"></span>
      </div>
    `}};y.shadowRootOptions=Object.assign(Object.assign({},s.shadowRootOptions),{delegatesFocus:!0}),y.styles=b,o([d({type:Boolean,reflect:!0})],y.prototype,"disabled",void 0),o([d({attribute:"icon-label"})],y.prototype,"iconLabel",void 0),o([d({reflect:!0})],y.prototype,"description",void 0),o([d({attribute:"label-text"})],y.prototype,"labelText",void 0),o([d()],y.prototype,"label",void 0),o([d({attribute:"secondary-label-text"})],y.prototype,"secondaryLabelText",void 0),o([d({attribute:"secondary-label"})],y.prototype,"secondaryLabel",void 0),o([d()],y.prototype,"state",void 0),o([d({type:Boolean,reflect:!0})],y.prototype,"vertical",void 0),o([d({type:Boolean,reflect:!0})],y.prototype,"spaceEqually",void 0),y=o([i(`${r}-progress-step`)],y);
/**
 * @license
 *
 * Copyright IBM Corp. 2019, 2023
 ...
 * LICENSE file in the root directory of this source tree.
 */
let x=class extends s{constructor(){super(...arguments),this.vertical=!1}render(){return t`
      <div
        class="${r}--progress-step-button ${r}--progress-step-button--unclickable">
        ${p()}
        <p class="${r}--progress-label">
          <cds-skeleton-text width="40px" linecount="1"></cds-skeleton-text>
        </p>
        <span class="${r}--progress-line"></span>
      </div>
    `}};x.styles=b,o([d({type:Boolean,reflect:!0})],x.prototype,"vertical",void 0),x=o([i(`${r}-progress-step-skeleton`)],x);
