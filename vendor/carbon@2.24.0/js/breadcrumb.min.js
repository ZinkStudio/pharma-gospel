 ...
 * This source code is licensed under the Apache-2.0 license found in the
 * LICENSE file in the root directory of this source tree.
 */let l=class extends t{constructor(){super(...arguments),this.noTrailingSlash=!1}connectedCallback(){this.hasAttribute("role")||this.setAttribute("role","navigation"),super.connectedCallback()}render(){const e=c({[`${s}--breadcrumb`]:!0,[`${s}--breadcrumb--no-trailing-slash`]:this.noTrailingSlash});return r`
      <ol class="${e}">
        <slot></slot>
      </ol>
    `}};l.styles=a,o([n({type:Boolean,reflect:!0,attribute:"no-trailing-slash"})],l.prototype,"noTrailingSlash",void 0),l=o([d(`${s}-breadcrumb`)],l);
/**
 * @license
 *
 * Copyright IBM Corp. 2019, 2023
 ...
 * LICENSE file in the root directory of this source tree.
 */
let p=class extends t{connectedCallback(){this.hasAttribute("role")||this.setAttribute("role","listitem"),super.connectedCallback()}render(){return r` <slot></slot> `}};p.styles=a,p=o([d(`${s}-breadcrumb-item`)],p);
/**
 * @license
 *
 * Copyright IBM Corp. 2019, 2023
 ...
 * LICENSE file in the root directory of this source tree.
 */
let v=class extends i{render(){return r`
      ${this.href?super.render():r`<span class="${s}--link"><slot></slot></span>`}
    `}};v.styles=a,v=o([d(`${s}-breadcrumb-link`)],v);
/**
 * @license
 *
 ...
 */
const b=()=>r`
    <div class="${s}--breadcrumb-item">
      <span class="${s}--link">&nbsp;</span>
    </div>
  `;let m=class extends t{render(){return r`
      <div class="${s}--breadcrumb ${s}--skeleton">
        ${b()} ${b()} ${b()}
      </div>
    `}};m.styles=a,m=o([d(`${s}-breadcrumb-skeleton`)],m);
