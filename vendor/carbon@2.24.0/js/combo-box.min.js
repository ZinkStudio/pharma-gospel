 ...
 * This source code is licensed under the Apache-2.0 license found in the
 * LICENSE file in the root directory of this source tree.
 */let u=class extends a{constructor(){super(...arguments),this._filterInputValue="",this._shouldTriggerBeFocusable=!1,this.clearSelectionLabel="Clear selection",this.inputLabel=""}_testItemWithQueryText(e){return(this.itemMatches||this._defaultItemMatches)(e,this._filterInputNode.value)}_defaultItemMatches(e,s){return e.textContent.toLowerCase().indexOf(s.toLowerCase())>=0}_handleInput(){0!=this._filterInputValue.length?this.setAttribute("isClosable",""):this.removeAttribute("isClosable");const e=this.querySelectorAll(this.constructor.selectorItem),s=this._filterInputNode.value?l(e,this._testItemWithQueryText,this):-1;n(e,((e,t)=>{var o;if(t===s){const s=null===(o=this._itemMenu)||void 0===o?void 0:o.getBoundingClientRect(),t=e.getBoundingClientRect();if(s&&t){if(!(s.top<=(null==t?void 0:t.top)&&(null==t?void 0:t.bottom)<=(null==s?void 0:s.top)+this._itemMenu.clientHeight)){const e=(null==t?void 0:t.top)-(null==s?void 0:s.top),o=(null==t?void 0:t.bottom)-(null==s?void 0:s.bottom);Math.abs(e)<Math.abs(o)?this._itemMenu.scrollTop+=e:this._itemMenu.scrollTop+=o}}}e.highlighted=t===s}));const{_filterInputNode:t}=this;this._filterInputValue=t?t.value:"",this.open=!0,this.requestUpdate()}_handleClickInner(e){var s;const{target:t}=e;(null===(s=this._selectionButtonNode)||void 0===s?void 0:s.contains(t))?this._handleUserInitiatedClearInput():super._handleClickInner(e)}_handleKeypressInner(e){var s;const{key:t}=e,o=this.constructor.getAction(t),{TRIGGERING:i}=b;!(null===(s=this._selectionButtonNode)||void 0===s?void 0:s.contains(e.target))||o!==i&&" "!==t?super._handleKeypressInner(e):this._handleUserInitiatedClearInput()}_handleUserInitiatedClearInput(){n(this.querySelectorAll(this.constructor.selectorItem),(e=>{e.highlighted=!1})),this._filterInputValue="",this._filterInputNode.focus(),this._handleUserInitiatedSelectItem()}_handleUserInitiatedSelectItem(e){e&&!this._selectionShouldChange(e)&&(this._filterInputValue=e.textContent||"",this.open=!1,this.requestUpdate()),super._handleUserInitiatedSelectItem(e)}_selectionDidChange(e){this.value=e?e.value:"",n(this.querySelectorAll(this.constructor.selectorItemSelected),(e=>{e.selected=!1,e.setAttribute("aria-selected","false")})),e&&(e.selected=!0,e.setAttribute("aria-selected","true")),this._handleUserInitiatedToggle(!1)}_renderLabel(){var e;const{disabled:s,inputLabel:d,label:c,open:r,readOnly:l,value:n,_activeDescendant:a,_filterInputValue:b,_handleInput:p}=this,m=i({[`${o}--text-input`]:!0,[`${o}--text-input--empty`]:!n});let g;if(r&&!a){const s=this.constructor;g=null===(e=this.querySelectorAll(s.selectorItem)[0])||void 0===e?void 0:e.id}return t`
      <input
        id="trigger-button"
        class="${m}"
        ?disabled=${s}
        ...
        aria-activedescendant="${x(r?null!=a?a:g:"")}"
        ?readonly=${l}
        @input=${p} />
    `}_renderFollowingLabel(){const{clearSelectionLabel:e,_filterInputValue:s}=this;return 0!=s.length?this.setAttribute("isClosable",""):this.removeAttribute("isClosable"),0===s.length?void 0:t`
          <div
            id="selection-button"
            role="button"
            class="${o}--list-box__selection"
            tabindex="0"
            title="${e}">
            ${r({"aria-label":e})}
          </div>
        `}shouldUpdate(e){super.shouldUpdate(e);const{_selectedItemContent:s}=this;return s&&e.has("value")&&(this._filterInputValue=(null==s?void 0:s.textContent)||""),!0}updated(e){super.updated(e);const{_listBoxNode:s}=this;s&&s.classList.add(`${o}--combo-box`)}static get selectorItemHighlighted(){return`${o}-combo-box-item[highlighted]`}static get selectorItem(){return`${o}-combo-box-item`}static get selectorItemSelected(){return`${o}-combo-box-item[selected]`}static get eventBeforeToggle(){return`${o}-combo-box-beingtoggled`}static get eventToggle(){return`${o}-combo-box-toggled`}static get eventBeforeSelect(){return`${o}-combo-box-beingselected`}static get eventSelect(){return`${o}-combo-box-selected`}};u.TRIGGER_KEYS=new Set(["Enter"]),u.styles=g,s([c("input")],u.prototype,"_filterInputNode",void 0),s([c("#menu-body")],u.prototype,"_itemMenu",void 0),s([c("#selection-button")],u.prototype,"_selectionButtonNode",void 0),s([d({attribute:"clear-selection-label"})],u.prototype,"clearSelectionLabel",void 0),s([d({attribute:"input-label"})],u.prototype,"inputLabel",void 0),s([d({attribute:!1})],u.prototype,"itemMatches",void 0),u=s([m(`${o}-combo-box`)],u);
/**
 * @license
 *
 ...
 * LICENSE file in the root directory of this source tree.
 */
let h=class extends p{};h.styles=g,h=s([m(`${o}-combo-box-item`)],h);
