 ...
 * This source code is licensed under the Apache-2.0 license found in the
 * LICENSE file in the root directory of this source tree.
 */let y=class extends o{constructor(){super(...arguments),this.disabled=!1,this.labelDescription="",this.labelTitle=""}updated(e){if(e.has("disabled")){const{selectorUploaderItem:e}=this.constructor;this.querySelector(e).disabled=this.disabled}}render(){const{disabled:e,labelDescription:t,labelTitle:o}=this,d=r({[`${i}--file--label`]:!0,[`${i}--label-description--disabled`]:e}),n=r({[`${i}--label-description`]:!0,[`${i}--label-description--disabled`]:e});return s`
      <p class="${d}">
        <slot name="label-title">${o}</slot>
      </p>
      <p class="${n}">
        <slot name="label-description">${t}</slot>
      </p>
      <slot name="drop-container"></slot>
      <div class="${i}--file-container">
        <slot></slot>
      </div>
    `}static get selectorUploaderItem(){return`${i}-file-uploader-button,${i}-file-uploader-drop-container`}};
/**
 * @license
 *
 ...
 * LICENSE file in the root directory of this source tree.
 */
var x,_;y.styles=u,t([d({type:Boolean,reflect:!0})],y.prototype,"disabled",void 0),t([d({attribute:"label-description"})],y.prototype,"labelDescription",void 0),t([d({attribute:"label-title"})],y.prototype,"labelTitle",void 0),y=t([n(`${i}-file-uploader`)],y),function(e){e.UPLOADING="uploading",e.COMPLETE="complete",e.EDIT="edit"}(x||(x={})),function(e){e.SMALL="sm",e.MEDIUM="md",e.LARGE="lg"}(_||(_={}));
/**
 * @license
 *
 ...
 * LICENSE file in the root directory of this source tree.
 */
let z=class extends o{constructor(){super(...arguments),this.iconDescription="Delete this file",this.invalid=!1,this.size=_.MEDIUM,this.state=x.UPLOADING,this.errorSubject="",this.errorBody=""}_handleClickDeleteButton(){const e={bubbles:!0,cancelable:!0,composed:!0},{eventBeforeDelete:t,eventDelete:o}=this.constructor;this.dispatchEvent(new CustomEvent(t,e))&&this.dispatchEvent(new CustomEvent(o,e))}_renderEditing(){const{iconDescription:e,invalid:t,_handleClickDeleteButton:o}=this;return s`
      ${t?l({class:`${i}--file-invalid`}):void 0}
      <button
        type="button"
        aria-label="${e}"
        class="${i}--file-close"
    ...
    `}_renderUploading(){const{iconDescription:e}=this;return s`
      <cds-loading
        assistive-text="${e}"
        type="${p.SMALL}"></cds-loading>
    `}_renderUploaded(){const{iconDescription:e}=this;return c({class:`${i}--file-complete`,"aria-label":e})}_renderStatus(){const{state:e}=this;switch(e){case x.EDIT:return this._renderEditing();case x.UPLOADING:return this._renderUploading();case x.COMPLETE:return this._renderUploaded();default:return}}render(){const{invalid:e,errorSubject:t,errorBody:o}=this;return s` <p class="${i}--file-filename"><slot></slot></p>
      <span class="${i}--file__state-container"
        >${this._renderStatus()}</span
      >
      <div
        class="${i}--form-requirement"
        ?hidden="${!e&&!t}">
        <div class="${i}--form-requirement__title">${t}</div>
        <p
          class="${i}--form-requirement__supplement"
          ?hidden="${!o}">
          ${o}
        </p>
      </div>`}static get eventBeforeDelete(){return`${i}-file-uploader-item-beingdeleted`}static get eventDelete(){return`${i}-file-uploader-item-deleted`}};z.styles=u,t([d({attribute:"icon-description"})],z.prototype,"iconDescription",void 0),t([d({type:Boolean,reflect:!0})],z.prototype,"invalid",void 0),t([d({reflect:!0})],z.prototype,"size",void 0),t([d({reflect:!0})],z.prototype,"state",void 0),t([d({attribute:"error-subject"})],z.prototype,"errorSubject",void 0),t([d({attribute:"error-body"})],z.prototype,"errorBody",void 0),z=t([n(`${i}-file-uploader-item`)],z);
/**
 * @license
 *
 ...
 * LICENSE file in the root directory of this source tree.
 */
const k={dragover:"copy",dragleave:"move"};let w=class extends(v(o)){constructor(){super(...arguments),this._active=!1,this.accept="",this.disabled=!1,this.multiple=!1,this.name="",this.slot="drop-container"}_handleChange(e){var t,o;const{eventChange:s,selectorInput:i}=this.constructor,{files:r}=null!==(t="drop"===e.type?e.dataTransfer:e.target)&&void 0!==t?t:{},d=this._getFiles(e,r);this.dispatchEvent(new CustomEvent(s,{bubbles:!0,composed:!0,detail:{addedFiles:d}}));const n=null===(o=null==this?void 0:this.shadowRoot)||void 0===o?void 0:o.querySelector(i);n&&(n.value="")}_handleDrag(e){if(e.preventDefault(),this.disabled)return;const{dataTransfer:t,type:o}=e,s=k[o];t&&s&&(t.dropEffect=s),this._active="dragover"===o,"drop"===o&&this._handleChange(e),this.requestUpdate()}_getFiles(e,t){const{accept:o}=this;if(!o||!/^(change|drop)$/.test(e.type))return Array.from(null!=t?t:[]);const s=new Set(o.split(" "));return Array.prototype.filter.call(t,(({name:e,type:t=""})=>{var o;const i=/\.[^.]+$/,r=i.test(e),[d]=r?null!==(o=i.exec(e))&&void 0!==o?o:[]:[void 0];return s.has(t)||d&&s.has(d)}))}render(){const{accept:e,disabled:t,multiple:o,name:d,_active:n,_handleChange:c}=this,a=r({[`${i}--file-browse-btn`]:!0,[`${i}--file-browse-btn--disabled`]:t}),l=r({[`${i}--file__drop-container`]:!0,[`${i}--file__drop-container--drag-over`]:n});return s`
      <label class="${a}" for="file" tabindex="0">
        <div class="${l}" role="button">
          <slot></slot>
          <input
            id="file"
            type="file"
    ...
    `}static get eventChange(){return`${i}-file-uploader-drop-container-changed`}static get selectorInput(){return`.${i}--file-input`}};w.styles=u,t([f("dragover"),f("dragleave"),f("drop")],w.prototype,"_handleDrag",null),t([d()],w.prototype,"accept",void 0),t([d({type:Boolean,reflect:!0})],w.prototype,"disabled",void 0),t([d({type:Boolean,reflect:!0})],w.prototype,"multiple",void 0),t([d({reflect:!0})],w.prototype,"name",void 0),t([d({reflect:!0})],w.prototype,"slot",void 0),w=t([n(`${i}-file-uploader-drop-container`)],w);
/**
 * @license
 *
 * Copyright IBM Corp. 2020, 2024
 ...
 * LICENSE file in the root directory of this source tree.
 */
let $=class extends(v(o)){constructor(){super(...arguments),this.buttonKind=b.PRIMARY,this.size=m.MEDIUM,this.accept="",this.disabled=!1,this.multiple=!1,this.name="",this.slot="drop-container"}_handleClick(e){var t,o,s;e.target.value=null;const{selectorInput:i}=this.constructor;null===(o=null===(t=null==this?void 0:this.shadowRoot)||void 0===t?void 0:t.querySelector(i))||void 0===o||o.setAttribute("value",""),(null===(s=null==this?void 0:this.shadowRoot)||void 0===s?void 0:s.querySelector(i)).click()}_handleKeyDown(e){var t,o,s;const{selectorInput:i}=this.constructor;"Enter"!==e.key&&"Space"!==e.key||(null===(o=null===(t=null==this?void 0:this.shadowRoot)||void 0===t?void 0:t.querySelector(i))||void 0===o||o.setAttribute("value",""),(null===(s=null==this?void 0:this.shadowRoot)||void 0===s?void 0:s.querySelector(i)).click())}_handleChange(e){var t;const o=this._getFiles(e),{eventChange:s,selectorInput:i}=this.constructor;this.dispatchEvent(new CustomEvent(s,{bubbles:!0,composed:!0,detail:{addedFiles:o}}));const r=null===(t=null==this?void 0:this.shadowRoot)||void 0===t?void 0:t.querySelector(i);r&&(r.value="")}_getFiles(e){var t;const{files:o}=null!==(t="drop"===e.type?e.dataTransfer:e.target)&&void 0!==t?t:{},{accept:s}=this;if(!s||!/^(change|drop)$/.test(e.type))return Array.from(null!=o?o:[]);const i=new Set(s.split(" "));return Array.prototype.filter.call(o,(({name:e,type:t=""})=>{var o;const s=/\.[^.]+$/,r=s.test(e),[d]=r?null!==(o=s.exec(e))&&void 0!==o?o:[]:[void 0];return i.has(t)||d&&i.has(d)}))}render(){const{accept:e,disabled:t,multiple:o,name:d,buttonKind:n,size:c,_handleChange:a}=this,l=r({[`${i}--file-browse-btn`]:!0,[`${i}--file-browse-btn--disabled`]:t}),p=r({[`${i}--btn`]:!0,[`${i}--btn--${n}`]:n,[`${i}--layout--size-${c}`]:c,[`${i}--btn--disabled`]:t,[`${i}--btn--${c}`]:c});return s`
      <button
        type="button"
        class="${p}"
      ...
      <input
        ...
        name="${g(d)}"
        @change="${a}" />
    `}static get eventChange(){return`${i}-file-uploader-button-changed`}static get selectorInput(){return`.${i}--file-input`}};$.styles=u,t([d({reflect:!0,attribute:"button-kind"})],$.prototype,"buttonKind",void 0),t([d({reflect:!0})],$.prototype,"size",void 0),t([d()],$.prototype,"accept",void 0),t([d({type:Boolean,reflect:!0})],$.prototype,"disabled",void 0),t([d({type:Boolean,reflect:!0})],$.prototype,"multiple",void 0),t([d({reflect:!0})],$.prototype,"name",void 0),t([d({reflect:!0})],$.prototype,"slot",void 0),$=t([n(`${i}-file-uploader-button`)],$);
/**
 * @license
 *
