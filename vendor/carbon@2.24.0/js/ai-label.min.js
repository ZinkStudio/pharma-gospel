 ...
 * This source code is licensed under the Apache-2.0 license found in the
 * LICENSE file in the root directory of this source tree.
 */!function(o){o.MINI="mini",o.EXTRA_EXTRA_SMALL="2xs",o.EXTRA_SMALL="xs",o.SMALL="sm",o.MEDIUM="md",o.LARGE="lg",o.EXTRA_LARGE="xl"}(i||(i={})),function(o){o.DEFAULT="",o.INLINE="inline"}(l||(l={}));
/**
 * @license
 *
 ...
 * LICENSE file in the root directory of this source tree.
 */
let g=class extends r{constructor(){super(...arguments),this.slot="ai-label",this.aiText="AI",this.aiTextLabel="",this.kind=l.DEFAULT,this.revertActive=!1,this.revertLabel="Revert to AI input",this.size=i.EXTRA_SMALL,this.buttonLabel="Show information",this._handleClick=()=>{this.revertActive?(this.revertActive=!1,this.removeAttribute("revert-active")):this.open=!this.open},this._renderToggleTipLabel=()=>e``,this._renderTooltipButton=()=>{const{size:o,kind:t,aiText:c,aiTextLabel:r,buttonLabel:d}=this,n=`${c} - ${d}`,a=p({[`${s}--toggletip-button`]:!0,[`${s}--slug__button`]:!0,[`${s}--slug__button--${o}`]:o,[`${s}--slug__button--${t}`]:t,[`${s}--slug__button--inline-with-content`]:t===l.INLINE&&r});return e`
      <button
        aria-controls="${this.id}"
        @click="${this._handleClick}"
        class=${a}
        aria-label="${n}">
        <span class="${s}--slug__text">${c}</span>
        ${r&&t===l.INLINE?e`
    ...
    `},this._renderInnerContent=()=>{const{autoalign:o,revertActive:t,revertLabel:s}=this;return e`
      ${t?e`
            <cds-icon-button
              ?autoalign=${o}
              kind="ghost"
          ...
          `}
    `}}attributeChangedCallback(o,t,e){var s;super.attributeChangedCallback(o,t,e),"revert-active"===o&&(null===(s=this.parentElement)||void 0===s||s.requestUpdate())}};g.styles=v,t([c({reflect:!0})],g.prototype,"slot",void 0),t([c({attribute:"ai-text"})],g.prototype,"aiText",void 0),t([c({attribute:"ai-text-label"})],g.prototype,"aiTextLabel",void 0),t([c({reflect:!0})],g.prototype,"kind",void 0),t([c({type:Boolean,attribute:"revert-active"})],g.prototype,"revertActive",void 0),t([c({attribute:"revert-label"})],g.prototype,"revertLabel",void 0),t([c({reflect:!0})],g.prototype,"size",void 0),t([c({attribute:"button-label"})],g.prototype,"buttonLabel",void 0),t([c()],g.prototype,"previousValue",void 0),g=t([n(`${s}-ai-label`)],g);
/**
 * @license
 *
 ...
 * LICENSE file in the root directory of this source tree.
 */
let h=class extends a{constructor(){super(...arguments),this.slot="actions"}};h.styles=v,t([c({reflect:!0})],h.prototype,"slot",void 0),h=t([n(`${s}-ai-label-action-button`)],h);
