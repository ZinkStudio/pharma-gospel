...
import{i as o,p as e,x as t,_ as s,r}from"./settings-a9cb5e4b.js";import{n}from"./property-4de26c93.js";import{H as c,a as d}from"./host-listener-69c546a1.js";import{F as i}from"./focus-969beaed.js";import{b as a,i as p}from"./collection-helpers-8b117611.js";import{C as l}from"./icon-button-6593fa47.js";import{c as v}from"./carbon-element-017b212d.js";import{C as f,F as b}from"./floating-menu-381b1978.js";import"./on-8707857f.js";import"./tooltip-content-1494fdba.js";import"./popover-content-aad0eb57.js";import"./class-map-e4ba9e2b.js";import"./directive-e2d48b9c.js";import"./query-602de8af.js";import"./popover-controller-97c2d68e.js";import"./button-266bf577.js";import"./if-defined-446d5754.js";import"./button-set-294c1e4e.js";import"./button-skeleton-9cd62d4c.js";
/**
 * @license
 *
 ...
 * This source code is licensed under the Apache-2.0 license found in the
 * LICENSE file in the root directory of this source tree.
 */let m=class extends(c(i(l))){constructor(){super(...arguments),this._menuBody=null,this._handleClickTrigger=async()=>{this._handleUserInitiatedToggle()},this._handleKeydownTrigger=async o=>{" "!==o.key&&"Enter"!==o.key||(this._handleUserInitiatedToggle(),o.preventDefault())},this.dataTable=!1,this.disabled=!1,this.flipped=!1,this.open=!1,this.index=1,this.size=g.MEDIUM,this.toolbarAction=!1}async _handleUserInitiatedToggle(){this.open=!this.open;const{index:o,open:t,updateComplete:s}=this;if(t){await s;const{_menuBody:t}=this,r=null==t?void 0:t.querySelector(`${e}-overflow-menu-item:nth-of-type(${o})`);null==r||r.focus()}}get triggerPosition(){return this.getBoundingClientRect()}connectedCallback(){this.hasAttribute("aria-haspopup")||this.setAttribute("aria-haspopup","true"),this.shadowRoot||this.attachShadow({mode:"open"}),super.connectedCallback()}updated(o){var t,s,r,n,c,d,i;const p=null===(s=null===(t=this.shadowRoot)||void 0===t?void 0:t.querySelector(`${e}-tooltip`))||void 0===s?void 0:s.querySelector("button");if(null==p||p.classList.add(`${e}--btn--icon-only`,`${e}--overflow-menu`),o.has("open")){const{open:o}=this;o&&!this._menuBody&&(this._menuBody=a(this.childNodes,(o=>o.constructor.FLOATING_MENU)));const{_menuBody:e}=this;if(e){e.open=o;const t=null===(r=this.querySelector("[slot=tooltip-content]"))||void 0===r?void 0:r.textContent;null==p||p.setAttribute("aria-expanded",String(Boolean(o))),null==p||p.setAttribute("aria-label",String(t))}}if(o.has("dataTable")){const o=null===(n=this.shadowRoot)||void 0===n?void 0:n.querySelector(`${e}-tooltip`);null==o||o.setAttribute("data-table","")}if(o.has("size")){const{size:o}=this,{_menuBody:t}=this;t&&(t.size=o),null==p||p.classList.forEach((o=>{o.startsWith(`${e}--overflow-menu--`)&&(null==p||p.classList.remove(o))})),null==p||p.classList.add(`${e}--overflow-menu--${this.size}`);const s=null===(c=this.shadowRoot)||void 0===c?void 0:c.querySelector(`${e}-tooltip`);null==s||s.setAttribute("size",this.size)}o.has("toolbarAction")&&this.toolbarAction&&(null===(i=null===(d=this.shadowRoot)||void 0===d?void 0:d.querySelector(`${e}-tooltip`))||void 0===i||i.setAttribute("toolbar-action","")),super.updated(o)}render(){return t` ${super.render()} `}};m.styles=h,s([d("click")],m.prototype,"_handleClickTrigger",void 0),s([d("keydown")],m.prototype,"_handleKeydownTrigger",void 0),s([n({type:Boolean,reflect:!0,attribute:"data-table"})],m.prototype,"dataTable",void 0),s([n({type:Boolean,reflect:!0})],m.prototype,"disabled",void 0),s([n({type:Boolean,reflect:!0})],m.prototype,"flipped",void 0),s([n({type:Boolean,reflect:!0})],m.prototype,"open",void 0),s([n()],m.prototype,"index",void 0),s([n({reflect:!0})],m.prototype,"size",void 0),s([n({type:Boolean,attribute:"toolbar-action",reflect:!0})],m.prototype,"toolbarAction",void 0),m=s([v(`${e}-overflow-menu`)],m);let y=class extends f{constructor(){super(...arguments),this.direction=b.BOTTOM,this.flipped=!1,this.open=!1,this.selected=null,this.size=g.MEDIUM,this._handleKeydown=async o=>{const{key:e}=o;this.open&&(this.contains(document.activeElement)&&(this.selected=document.activeElement),e in u&&this._navigate(u[e]),"Escape"===e&&(this.open=!1))}}_getNextItem(o,e){const{selectorItemEnabled:t}=this.constructor,s=this.querySelectorAll(t),r=p(s,o),n=(c=r+e,d=s.length,c<0?d-1:c>=d?0:c);var c,d;return n===r?null:s[n]}_navigate(o){if(this.selected){const e=this._getNextItem(this.selected,o);null==e||e.focus()}}connectedCallback(){this.hasAttribute("role")||this.setAttribute("role","menu"),this.hasAttribute("tabindex")||this.setAttribute("tabindex","-1"),super.connectedCallback()}updated(o){if(o.has("size")){const{selectorMenuItem:o}=this.constructor;this.querySelectorAll(o).forEach((o=>{o.setAttribute("size",this.size)}))}super.updated(o)}render(){return t` <slot></slot> `}static get selectorMenuItem(){return`${e}-overflow-menu-item`}static get selectorItemEnabled(){return`${e}-overflow-menu-item:not([disabled])`}};y.styles=h,s([n()],y.prototype,"direction",void 0),s([n({type:Boolean,reflect:!0})],y.prototype,"flipped",void 0),s([n({type:Boolean,reflect:!0})],y.prototype,"open",void 0),s([n({reflect:!0})],y.prototype,"size",void 0),s([d("keydown")],y.prototype,"_handleKeydown",void 0),y=s([v(`${e}-overflow-menu-body`)],y);
/**
 * @license
 *
 * Copyright IBM Corp. 2019, 2023
 ...
 * LICENSE file in the root directory of this source tree.
 */
let w=class extends(i(r)){constructor(){super(...arguments),this.danger=!1,this.disabled=!1,this.divider=!1,this.href="",this.size=g.MEDIUM}connectedCallback(){this.hasAttribute("role")||this.setAttribute("role","menuitem"),super.connectedCallback()}render(){return this.href?t`
          <a
            class="${e}--overflow-menu-options__btn"
            ?disabled=${this.disabled}
            href="${this.href}"
            tabindex="-1">
            <div class="${e}--overflow-menu-options__option-content">
              <slot></slot>
            </div>
          </a>
        `:t`
        ...
        `}};w.shadowRootOptions=Object.assign(Object.assign({},r.shadowRootOptions),{delegatesFocus:!0}),w.styles=h,s([n({type:Boolean,reflect:!0})],w.prototype,"danger",void 0),s([n({type:Boolean,reflect:!0})],w.prototype,"disabled",void 0),s([n({type:Boolean,reflect:!0})],w.prototype,"divider",void 0),s([n()],w.prototype,"href",void 0),s([n({reflect:!0})],w.prototype,"size",void 0),w=s([v(`${e}-overflow-menu-item`)],w);
