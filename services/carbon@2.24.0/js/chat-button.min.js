...
import{i as t,_ as e,r as o,p as s,x as n}from"./settings-a9cb5e4b.js";import{n as c}from"./property-4de26c93.js";import{c as d}from"./carbon-element-017b212d.js";import"./button-266bf577.js";import{e as i}from"./class-map-e4ba9e2b.js";import"./if-defined-446d5754.js";import"./focus-969beaed.js";import"./host-listener-69c546a1.js";import"./on-8707857f.js";import"./directive-e2d48b9c.js";
/**
 * @license
 *
 ...
 * This source code is licensed under the Apache-2.0 license found in the
 * LICENSE file in the root directory of this source tree.
 */let l=class extends o{constructor(){super(...arguments),this._hasIcon=!1,this.disabled=!1,this.kind=a.PRIMARY,this.size=r.LARGE,this.isQuickAction=!1,this.isSelected=!1}_handleSlotChange({target:t}){this._hasIcon=t.assignedNodes().some((t=>t.nodeType!==Node.TEXT_NODE||t.textContent.trim())),this.requestUpdate()}render(){const t=[r.SMALL,r.MEDIUM,r.LARGE];this.isQuickAction?(this.kind=a.GHOST,this.size=r.SMALL):this.size=t.includes(this.size)?this.size:r.LARGE;let e=`${s}--chat-btn`;return e+=this._hasIcon?` ${s}--chat-btn--with-icon`:"",e+=this.isQuickAction?` ${s}--chat-btn--quick-action`:"",e+=this.isSelected?` ${s}--chat-btn--quick-action--selected`:"",n`
      <cds-button
        button-class-name="${e}"
        size="${this.size}"
        kind="${this.kind}"
    ...
    `}};l.styles=p,e([c({type:Boolean,reflect:!0})],l.prototype,"disabled",void 0),e([c({reflect:!0})],l.prototype,"kind",void 0),e([c({reflect:!0})],l.prototype,"size",void 0),e([c({attribute:"is-quick-action",type:Boolean})],l.prototype,"isQuickAction",void 0),e([c({attribute:"is-selected",type:Boolean})],l.prototype,"isSelected",void 0),l=e([d(`${s}-chat-button`)],l);
/**
 * @license
 *
 * Copyright IBM Corp. 2019, 2024
 ...
 * LICENSE file in the root directory of this source tree.
 */
let b=class extends o{constructor(){super(...arguments),this.size=r.LARGE}render(){const t=i({[`${s}--skeleton`]:!0,[`${s}--btn`]:!0,[`${s}--chat-btn`]:!0,[`${s}--layout--size-${this.size}`]:this.size});return n` <div class="${t}"></div> `}};b.styles=p,e([c({reflect:!0})],b.prototype,"size",void 0),b=e([d(`${s}-chat-button-skeleton`)],b);
