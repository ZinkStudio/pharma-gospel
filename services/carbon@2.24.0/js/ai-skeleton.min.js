 ...
 * This source code is licensed under the Apache-2.0 license found in the
 * LICENSE file in the root directory of this source tree.
 */let c=class extends n{constructor(){super(...arguments),this.customStyles=""}render(){return t`<cds-skeleton-icon
      class="${s}--skeleton__icon--ai"
      style="${this.customStyles}"></cds-skeleton-icon>`}};c.styles=a,o([i({attribute:"custom-styles"})],c.prototype,"customStyles",void 0),c=o([r(`${s}-ai-skeleton-icon`)],c);
/**
 * @license
 *
 * Copyright IBM Corp. 2019, 2024
 ...
 * LICENSE file in the root directory of this source tree.
 */
let l=class extends n{render(){return t`<cds-skeleton-placeholder
      optional-classes="${s}--skeleton__placeholder--ai"></cds-skeleton-placeholder>`}};l.styles=a,l=o([r(`${s}-ai-skeleton-placeholder`)],l);
/**
 * @license
 *
 * Copyright IBM Corp. 2019, 2024
 ...
 * LICENSE file in the root directory of this source tree.
 */
let d=class extends n{constructor(){super(...arguments),this.heading=!1,this.width="100%",this.paragraph=!1,this.lineCount=3}render(){const{heading:e,width:o,lineCount:n,paragraph:i}=this;return t`<cds-skeleton-text
      type="${e?"heading":""}"
      width="${o}"
      linecount="${n}"
      ?paragraph="${i}"
      optional-classes="${s}--skeleton__text--ai"></cds-skeleton-text>`}};d.styles=a,o([i({type:Boolean,reflect:!0})],d.prototype,"heading",void 0),o([i({reflect:!0})],d.prototype,"width",void 0),o([i({type:Boolean,reflect:!0})],d.prototype,"paragraph",void 0),o([i({type:Number,reflect:!0})],d.prototype,"lineCount",void 0),d=o([r(`${s}-ai-skeleton-text`)],d);
