 ...
 * This source code is licensed under the Apache-2.0 license found in the
 * LICENSE file in the root directory of this source tree.
 */const A={Left:-1,ArrowLeft:-1,Up:-1,ArrowUp:-1,Right:1,ArrowRight:1,Down:1,ArrowDown:1};let Y=class extends(l(c(o(s)))){constructor(){super(...arguments),this._max="100",this._min="0",this._step="1",this._stepMultiplier="4",this._throttledHandlePointermoveImpl=null,this._dragging=!1,this._handlePointermove=e=>{const{disabled:t,_dragging:i}=this;!t&&i&&this._throttledHandlePointermoveImpl(e)},this._endDrag=()=>{this._dragging&&(this.dispatchEvent(new CustomEvent(this.constructor.eventChange,{bubbles:!0,composed:!0,detail:{value:this.value}})),this._dragging=!1,this._thumbNode.style.touchAction="")},this._handleChangeInput=({detail:e})=>{const{intermediate:t,value:i}=e;this.value=i,this.dispatchEvent(new CustomEvent(this.constructor.eventChange,{bubbles:!0,composed:!0,detail:{value:i,intermediate:t}}))},this.disabled=!1,this.required=!1,this.readonly=!1,this.labelText="",this.maxLabel="",this.minLabel="",this.formatMaxText=(e,t)=>`${e}${t}`,this.formatMinText=(e,t)=>`${e}${t}`,this.invalid=!1,this.invalidText="",this.warn=!1,this.warnText=""}get _rate(){const{max:e,min:t,value:i}=this;return(Math.min(Number(e),Math.max(Number(t),i))-Number(t))/(Number(e)-Number(t))}set _rate(e){const{max:t,min:i,step:s}=this;this.value=Number(i)+Math.round((Number(t)-Number(i))*Math.min(1,Math.max(0,e))/Number(s))*Number(s)}_handleClickLabel(){var e;null===(e=this._thumbNode)||void 0===e||e.focus()}_handleFormdata(e){const{formData:t}=e,{disabled:i,name:s,value:d}=this;i||t.append(s,String(d))}_handleKeydown({key:e,shiftKey:t}){if(!this.disabled&&e in A){const{max:i,min:s,step:d,stepMultiplier:r,value:n}=this,a=Number(i),o=Number(s),c=Number(d),l=Number(r),p=(t?(a-o)/l:c)*A[e],u=(n+p)/c;this.value=Math.min(a,Math.max(o,(p>=0?Math.floor(u):Math.ceil(u))*c)),this.dispatchEvent(new CustomEvent(this.constructor.eventChange,{bubbles:!0,composed:!0,detail:{value:this.value,intermediate:!1}}))}}_startDrag(){this._dragging=!0,this._thumbNode.style.touchAction="none"}_handleClick(e){if(!this.disabled){const{_trackNode:t}=this,i="rtl"===t.ownerDocument.defaultView.getComputedStyle(t).getPropertyValue("direction"),s=e.clientX,{left:d,width:r}=t.getBoundingClientRect();this._rate=(i?d+r-s:s-d)/r,this.dispatchEvent(new CustomEvent(this.constructor.eventChange,{bubbles:!0,composed:!0,detail:{value:this.value}}))}}_handlePointermoveImpl(e){const{disabled:t,_dragging:i,_trackNode:s}=this;if(!t&&i){const t="rtl"===s.ownerDocument.defaultView.getComputedStyle(s).getPropertyValue("direction"),i=e.clientX,{left:d,width:r}=this._trackNode.getBoundingClientRect();this._rate=(t?d+r-i:i-d)/r,this.dispatchEvent(new CustomEvent(this.constructor.eventChange,{bubbles:!0,composed:!0,detail:{value:this.value,intermediate:!0}}))}}get max(){return this._max.toString()}set max(e){const{max:t}=this;this._max=e,this.requestUpdate("max",t)}get min(){return this._min.toString()}set min(e){const{min:t}=this;this._min=e,this.requestUpdate("min",t)}get step(){return this._step.toString()}set step(e){const{step:t}=this;this._step=e,this.requestUpdate("step",t)}get stepMultiplier(){return this._stepMultiplier.toString()}set stepMultiplier(e){const{stepMultiplier:t}=this;this._stepMultiplier=e,this.requestUpdate("stepMultiplier",t)}_getInputValidity(e){return!this.invalid&&!((null==e?void 0:e.valueAsNumber)>Number(this.max)||(null==e?void 0:e.valueAsNumber)<Number(this.min))}connectedCallback(){super.connectedCallback(),this._throttledHandlePointermoveImpl||(this._throttledHandlePointermoveImpl=function(e,t,i){var s=!0,d=!0;if("function"!=typeof e)throw new TypeError("Expected a function");return b(i)&&(s="leading"in i?!!i.leading:s,d="trailing"in i?!!i.trailing:d),D(e,t,{leading:s,maxWait:t,trailing:d})}(this._handlePointermoveImpl,10))}disconnectedCallback(){this._throttledHandlePointermoveImpl&&(this._throttledHandlePointermoveImpl.cancel(),this._throttledHandlePointermoveImpl=null),super.disconnectedCallback()}shouldUpdate(e){var t;const i=this.querySelector(this.constructor.selectorInput);if(e.has("disabled")&&(i&&(i.disabled=this.disabled),this.disabled&&(this._dragging=!1)),e.has("readonly")&&(i&&(i.readonly=this.readonly),this.readonly&&(this._dragging=!1)),i&&(["max","min","step","value"].forEach((t=>{e.has(t)&&(i[t]=this[t])})),e.has("value")||e.has("invalid")||e.has("warn")||e.has("readonly"))){const e=null===(t=null==i?void 0:i.shadowRoot)||void 0===t?void 0:t.querySelector("input");this.isValid=this._getInputValidity(e),this.readonly||this.isValid?i.invalid=!1:i.invalid=!0,!this.readonly&&!this.invalid&&this.warn&&this.isValid?i.warn=!0:i.warn=!1}return!0}render(){const{disabled:e,formatMaxText:s,formatMinText:d,labelText:r,max:n,min:o,maxLabel:c,minLabel:l,readonly:p,invalidText:u,isValid:m,warn:h,warnText:g,value:b,_rate:f,_handleClickLabel:v,_handleKeydown:_,_handleClick:x,_startDrag:y,_endDrag:w}=this,z=a({[`${i}--label`]:!0,[`${i}--label--disabled`]:e}),k=a({[`${i}--slider`]:!0,[`${i}--slider--disabled`]:e,[`${i}--slider--readonly`]:p});return t`
      <label class="${z}" @click="${v}">
        <slot name="label-text">${r}</slot>
      </label>
      <div class="${i}--slider-container">
        <span class="${i}--slider__range-label">
          <slot name="min-text">${d(o,l)}</slot>
        </span>
        <div
          @keydown="${_}"
          @click="${x}"
          ...
          <div
            ...
            style="left: ${100*f}%"
            @pointerdown="${y}"></div>
          <div id="track" class="${i}--slider__track"></div>
          <div class="${i}-ce--slider__filled-track-container">
            <div
              class="${i}--slider__filled-track"
              style="transform: translate(0%, -50%) scaleX(${f})"></div>
          </div>
        </div>
        <span class="${i}--slider__range-label">
          <slot name="max-text">${s(n,c)}</slot>
        </span>
        <slot></slot>
      </div>
      ...
      ${p||m?null:t`
            <div
              class="${i}--slider__validation-msg ${i}--slider__validation-msg--invalid ${i}--form-requirement">
              ${u}
            </div>
          `}
      ${!p&&h&&m?t`<div
            class="${i}--slider__validation-msg ${i}--form-requirement">
            ${g}
          </div>`:null}
    `}static get selectorInput(){return`${i}-slider-input`}static get eventChange(){return`${i}-slider-changed`}static get eventChangeInput(){return`${i}-slider-input-changed`}};Y.shadowRootOptions=Object.assign(Object.assign({},s.shadowRootOptions),{delegatesFocus:!0}),Y.styles=H,d([n("#thumb")],Y.prototype,"_thumbNode",void 0),d([n("#track")],Y.prototype,"_trackNode",void 0),d([p("document:pointermove")],Y.prototype,"_handlePointermove",void 0),d([p("eventChangeInput")],Y.prototype,"_handleChangeInput",void 0),d([r({type:Boolean,reflect:!0})],Y.prototype,"disabled",void 0),d([r({type:Boolean,reflect:!0})],Y.prototype,"required",void 0),d([r({type:Boolean,reflect:!0})],Y.prototype,"readonly",void 0),d([r({attribute:"label-text"})],Y.prototype,"labelText",void 0),d([r({attribute:"max-label",reflect:!0})],Y.prototype,"maxLabel",void 0),d([r({attribute:"min-label",reflect:!0})],Y.prototype,"minLabel",void 0),d([r({attribute:!1})],Y.prototype,"formatMaxText",void 0),d([r({attribute:!1})],Y.prototype,"formatMinText",void 0),d([r({type:Number,reflect:!0})],Y.prototype,"max",null),d([r({type:Number,reflect:!0})],Y.prototype,"min",null),d([r()],Y.prototype,"name",void 0),d([r({type:Boolean,reflect:!0})],Y.prototype,"invalid",void 0),d([r({attribute:"invalid-text"})],Y.prototype,"invalidText",void 0),d([r({type:Boolean,reflect:!0})],Y.prototype,"warn",void 0),d([r({attribute:"warn-text"})],Y.prototype,"warnText",void 0),d([r({type:Number,reflect:!0})],Y.prototype,"step",null),d([r({type:Number,reflect:!0,attribute:"step-multiplier"})],Y.prototype,"stepMultiplier",null),d([r({type:Number})],Y.prototype,"value",void 0),d([r({type:Boolean})],Y.prototype,"isValid",void 0),Y=d([u(`${i}-slider`)],Y);
/**
 * @license
 *
 ...
 * LICENSE file in the root directory of this source tree.
 */
let K=class extends(o(s)){constructor(){super(...arguments),this._max="100",this._min="0",this._step="1",this.disabled=!1,this.invalid=!1,this.warn=!1,this.type="number",this.readonly=!1}_handleChange({target:e}){this.dispatchEvent(new CustomEvent(this.constructor.eventChange,{bubbles:!0,composed:!0,detail:{value:Number(e.value)}}))}_handleInput({target:e}){this.dispatchEvent(new CustomEvent(this.constructor.eventChange,{bubbles:!0,composed:!0,detail:{value:Number(e.value),intermediate:!0}}))}get max(){return this._max.toString()}set max(e){const{max:t}=this;this._max=e,this.requestUpdate("max",t)}get min(){return this._min.toString()}set min(e){const{min:t}=this;this._min=e,this.requestUpdate("min",t)}get step(){return this._step.toString()}set step(e){const{step:t}=this;this._step=e,this.requestUpdate("step",t)}render(){const{disabled:e,max:s,min:d,readonly:r,step:n,type:o,value:c,invalid:l,warn:p,_handleChange:u,_handleInput:b}=this,f=a({[`${i}--text-input`]:!0,[`${i}--slider-text-input`]:!0,[`${i}--text-input--invalid`]:l,[`${i}--slider-text-input--warn`]:p}),v=h({class:`${i}--slider__invalid-icon`}),_=g({class:`${i}--slider__invalid-icon ${i}--slider__invalid-icon--warning`});return t`
      <input
        ?disabled="${e}"
        ?data-invalid="${l}"
        type="${m(o)}"
      ...
      ${l?t`${v}`:null}
      ${p?t`${_}`:null}
    `}static get selectorParent(){return`${i}-slider`}static get eventChange(){return`${i}-slider-input-changed`}};K.shadowRootOptions=Object.assign(Object.assign({},s.shadowRootOptions),{delegatesFocus:!0}),K.styles=H,d([r({type:Boolean,reflect:!0})],K.prototype,"disabled",void 0),d([r({type:Boolean,reflect:!0})],K.prototype,"invalid",void 0),d([r({type:Boolean,reflect:!0})],K.prototype,"warn",void 0),d([r({type:Number,reflect:!0})],K.prototype,"max",null),d([r({type:Number,reflect:!0})],K.prototype,"min",null),d([r({type:Number,reflect:!0})],K.prototype,"step",null),d([r()],K.prototype,"type",void 0),d([r({type:Number})],K.prototype,"value",void 0),d([r({type:Boolean,reflect:!0})],K.prototype,"readonly",void 0),K=d([u(`${i}-slider-input`)],K);
/**
 * @license
 *
 * Copyright IBM Corp. 2019, 2023
 ...
 * LICENSE file in the root directory of this source tree.
 */
let W=class extends s{render(){return t`
      <span class="${i}--label ${i}--skeleton"></span>
      <div class="${i}--slider-container ${i}--skeleton">
        <span class="${i}--slider__range-label"></span>
        <div class="${i}--slider">
          <div class="${i}--slider__track"></div>
          <div class="${i}--slider__filled-track"></div>
          <div class="${i}--slider__thumb"></div>
        </div>
        <span class="${i}--slider__range-label"></span>
      </div>
    `}};W.styles=H,W=d([u(`${i}-slider-skeleton`)],W);
