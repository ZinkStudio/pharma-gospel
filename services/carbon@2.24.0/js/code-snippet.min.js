...
import{T as e,i as t,r as o,_ as s,p as n,x as c}from"./settings-a9cb5e4b.js";import{e as i,i as d,t as r}from"./directive-e2d48b9c.js";import{n as p}from"./property-4de26c93.js";import{s as a}from"./16-10c4fb8b.js";import{F as l}from"./focus-969beaed.js";import"./shared-enums-562e6b51.js";import"./copy-button-1a76bb42.js";import"./button-266bf577.js";import{c as v}from"./carbon-element-017b212d.js";import"./spread-279bf949.js";import"./defs-eaf95cbc.js";import"./icon-button-6593fa47.js";import"./tooltip-content-1494fdba.js";import"./host-listener-69c546a1.js";import"./on-8707857f.js";import"./popover-content-aad0eb57.js";import"./class-map-e4ba9e2b.js";import"./query-602de8af.js";import"./popover-controller-97c2d68e.js";import"./button-set-294c1e4e.js";import"./button-skeleton-9cd62d4c.js";import"./if-defined-446d5754.js";
/**
 * @license
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const h="important",b=" !"+h,g=i(class extends d{constructor(e){if(super(e),e.type!==r.ATTRIBUTE||"style"!==e.name||e.strings?.length>2)throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.")}render(e){return Object.keys(e).reduce(((t,o)=>{const s=e[o];return null==s?t:t+`${o=o.includes("-")?o:o.replace(/(?:^(webkit|moz|ms|o)|)(?=[A-Z])/g,"-$&").toLowerCase()}:${s};`}),"")}update(t,[o]){const{style:s}=t.element;if(void 0===this.ft)return this.ft=new Set(Object.keys(o)),this.render(o);for(const e of this.ft)null==o[e]&&(this.ft.delete(e),e.includes("-")?s.removeProperty(e):s[e]=null);for(const e in o){const t=o[e];if(null!=t){this.ft.add(e);const o="string"==typeof t&&t.endsWith(b);e.includes("-")||o?s.setProperty(e,o?t.slice(0,-11):t,o?h:""):s[e]=t}}return e}});
/**
 * @license
 *
 ...
 * This source code is licensed under the Apache-2.0 license found in the
 * LICENSE file in the root directory of this source tree.
 */let m=class extends(l(o)){constructor(){super(...arguments),this._expandedCode=!1,this._hObserveResize=null,this._rowHeightInPixels=16,this._hasRightOverflow=!0,this._hasLeftOverflow=!1,this._shouldShowMoreLessBtn=!1,this._resizeObserver=new ResizeObserver((()=>{var e;const t=null===(e=this.shadowRoot)||void 0===e?void 0:e.querySelector(`.${n}--snippet-container`),o=null==t?void 0:t.querySelector("code"),{type:s,maxCollapsedNumberOfRows:c,maxExpandedNumberOfRows:i,minExpandedNumberOfRows:d,_rowHeightInPixels:r,_handleScroll:p}=this;if(o&&s===f.MULTI){const{height:e}=o.getBoundingClientRect();this._shouldShowMoreLessBtn=c>0&&(i<=0||i>c)&&e>c*r,this._expandedCode&&d>0&&e<=d*r&&(this._expandedCode=!1)}(o&&s===f.MULTI||t&&s===f.SINGLE)&&p(),this.requestUpdate()})),this.copyText="",this.disabled=!1,this.feedback="Copied!",this.feedbackTimeout=2e3,this.hideCopyButton=!1,this.maxCollapsedNumberOfRows=15,this.maxExpandedNumberOfRows=0,this.minCollapsedNumberOfRows=3,this.minExpandedNumberOfRows=16,this.showLessText="Show less",this.showMoreText="Show more",this.tooltipContent="Copy to clipboard",this.wrapText=!1,this.type=f.SINGLE}_handleCopyClick(){const{ownerDocument:e}=this,t=e.defaultView.getSelection();t.removeAllRanges();const o=e.createElement("code");o.className=`${n}--visually-hidden`;const s=e.createElement("pre"),c=Array.from(this.childNodes).filter((e=>e.nodeType===Node.TEXT_NODE));s.textContent=this.copyText||c[0].textContent,o.appendChild(s),e.body.appendChild(o);const i=e.createRange();i.selectNodeContents(o),t.addRange(i),e.execCommand("copy"),e.body.removeChild(o),t.removeAllRanges()}_getCodeRefDimensions(e){const{clientWidth:t,scrollLeft:o,scrollWidth:s}=e;return{horizontalOverflow:s>t,codeClientWidth:t,codeScrollWidth:s,codeScrollLeft:o}}_handleScroll(){var e;if(this){const t=null===(e=null==this?void 0:this.shadowRoot)||void 0===e?void 0:e.querySelector(`.${n}--snippet-container`),o=null==t?void 0:t.querySelector("pre");if(this.type===f.INLINE||this.type===f.SINGLE&&!t||this.type===f.MULTI&&!o)return;const{horizontalOverflow:s,codeClientWidth:c,codeScrollWidth:i,codeScrollLeft:d}=this.type===f.SINGLE?this._getCodeRefDimensions(t):this._getCodeRefDimensions(o);this._hasLeftOverflow=s&&!!d,this._hasRightOverflow=s&&d+c!==i,this.requestUpdate()}}_handleClickExpanded(){this._expandedCode=!this._expandedCode,this.requestUpdate()}connectedCallback(){var e,t;super.connectedCallback(),this._hObserveResize&&(this._hObserveResize=this._hObserveResize.release()),this._hObserveResize=(e=this._resizeObserver,(t=this)?(e.observe(t),{release:()=>(e.unobserve(t),null)}):null)}disconnectedCallback(){this._hObserveResize&&(this._hObserveResize=this._hObserveResize.release())}updated(){this._expandedCode?this.setAttribute("expanded-code",""):this.removeAttribute("expanded-code")}render(){const{disabled:e,feedback:t,feedbackTimeout:o,hideCopyButton:s,maxExpandedNumberOfRows:i,minExpandedNumberOfRows:d,maxCollapsedNumberOfRows:r,minCollapsedNumberOfRows:p,type:l,wrapText:v,tooltipContent:h,showMoreText:b,showLessText:u,_expandedCode:m,_handleCopyClick:y,_handleScroll:x,_hasRightOverflow:k,_hasLeftOverflow:z,_rowHeightInPixels:_,_shouldShowMoreLessBtn:w}=this;let S=`${n}--snippet`;l&&(S+=` ${n}--snippet--${l}`),"inline"!==l&&e&&(S+=` ${n}--snippet--disabled`),s&&(S+=` ${n}--snippet--no-copy`),v&&(S+=` ${n}--snippet--wraptext`),"multi"==l&&k&&(S+=` ${n}--snippet--has-right-overflow`);const M=`${n}--snippet-btn--expand`,R=e?`${n}--snippet--disabled`:"",N=m?u:b;if(l===f.INLINE)return c`
        <cds-copy button-class-name="${S}" @click="${y}">
          <code slot="icon"><slot></slot></code>
          <span slot="tooltip-content">${h}</span>
        </cds-copy>
      `;const T={};return"multi"===l&&(m?(i>0&&(T["max-height"]=i*_+"px"),d>0&&(T["min-height"]=d*_+"px")):(r>0&&(T["max-height"]=r*_+"px"),p>0&&(T["min-height"]=p*_+"px"))),c`
      <div
        role="${l===f.SINGLE||l===f.MULTI?"textbox":null}"
        tabindex="${l!==f.SINGLE&&l!==f.MULTI||e?null:0}"
        class="${n}--snippet-container"
        aria-label="${"code-snippet"}"
        aria-readonly="${l===f.SINGLE||l===f.MULTI||null}"
        aria-multiline="${l===f.MULTI||null}"
        @scroll="${l===f.SINGLE&&x||null}"
        style=${g(T)}>
        <pre
          @scroll="${l===f.MULTI&&x||null}"><code><slot></slot></code></pre>
      </div>

      ${z?c`
            <div class="${n}--snippet__overflow-indicator--left"></div>
          `:""}
      ${k&&l!==f.MULTI?c`
            <div class="${n}--snippet__overflow-indicator--right"></div>
          `:""}
      ${s?"":c`
            <cds-copy-button
              ?disabled=${e}
      ...
      ${w?c`
            <cds-button
              ...
              <span class="${n}--snippet-btn--text">
                ${N}
              </span>
              ${a({class:`${n}--icon-chevron--down ${n}--snippet__icon`,name:"cheveron--down",role:"img",slot:"icon"})}
            </cds-button>
          `:""}
    `}};m.shadowRootOptions=Object.assign(Object.assign({},o.shadowRootOptions),{delegatesFocus:!0}),m.styles=u,s([p({attribute:"copy-text"})],m.prototype,"copyText",void 0),s([p({type:Boolean,reflect:!0})],m.prototype,"disabled",void 0),s([p()],m.prototype,"feedback",void 0),s([p({type:Number,attribute:"feedback-timeout"})],m.prototype,"feedbackTimeout",void 0),s([p({type:Boolean,reflect:!0,attribute:"hide-copy-button"})],m.prototype,"hideCopyButton",void 0),s([p()],m.prototype,"maxCollapsedNumberOfRows",void 0),s([p()],m.prototype,"maxExpandedNumberOfRows",void 0),s([p()],m.prototype,"minCollapsedNumberOfRows",void 0),s([p()],m.prototype,"minExpandedNumberOfRows",void 0),s([p({attribute:"show-less-text"})],m.prototype,"showLessText",void 0),s([p({attribute:"show-more-text"})],m.prototype,"showMoreText",void 0),s([p({attribute:"tooltip-content"})],m.prototype,"tooltipContent",void 0),s([p({type:Boolean,reflect:!0,attribute:"wrap-text"})],m.prototype,"wrapText",void 0),s([p({reflect:!0})],m.prototype,"type",void 0),m=s([v(`${n}-code-snippet`)],m);
/**
 * @license
 *
 * Copyright IBM Corp. 2019, 2023
 ...
 * LICENSE file in the root directory of this source tree.
 */
let y=class extends o{constructor(){super(...arguments),this.type=f.SINGLE}render(){return c`
      <div class="${n}--snippet-container">
        ${this.type!==f.MULTI?c` <span></span> `:c` <span></span><span></span><span></span> `}
      </div>
    `}};y.styles=u,s([p({reflect:!0})],y.prototype,"type",void 0),y=s([v(`${n}-code-snippet-skeleton`)],y);
