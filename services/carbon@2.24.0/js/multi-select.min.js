...
import{i as e,_ as t,x as s,p as i}from"./settings-a9cb5e4b.js";import{n as o}from"./property-4de26c93.js";import{e as c}from"./query-602de8af.js";import{e as d}from"./class-map-e4ba9e2b.js";import{s as l}from"./16-e32fa89f.js";import{f as a,c as r,i as n}from"./collection-helpers-8b117611.js";import{C as b,D as p,b as u,a as m}from"./dropdown-item-99152e0d.js";import{c as g}from"./carbon-element-017b212d.js";import{o as _}from"./if-defined-446d5754.js";import"./directive-e2d48b9c.js";import"./spread-279bf949.js";import"./state-225ff428.js";import"./16-10c4fb8b.js";import"./16-8449b4fa.js";import"./16-b826e67b.js";import"./focus-969beaed.js";import"./form-a750a2ac.js";import"./on-8707857f.js";import"./host-listener-69c546a1.js";import"./validity-45b7794a.js";import"./shared-enums-562e6b51.js";
/**
 * @license
 *
 ...
 * This source code is licensed under the Apache-2.0 license found in the
 * LICENSE file in the root directory of this source tree.
 */let f=class extends b{constructor(){super(...arguments),this._selectedItemsCount=0,this.clearSelectionLabel="",this.clearSelectionDescription="Total items selected: ",this.clearSelectionText="To clear selection, press Delete or Backspace.",this.locale="en",this.selectionFeedback=x.TOP_AFTER_REOPEN,this.compareItems=(e,t,{locale:s})=>{e.localeCompare(t,s,{numeric:!0})},this.sortItems=(e,{values:t,compareItems:s,locale:i="en"})=>Array.from(e).sort(((e,o)=>{const c=t.includes(e.value),d=t.includes(o.value);return c&&!d?-1:d&&!c?1:s(e.value,o.value,{locale:i})}))}_selectionShouldChange(e){return Boolean(this.value||e)}_selectionDidChange(e){e?e.selected=!e.selected:(a(this.querySelectorAll(this.constructor.selectorItemSelected),(e=>{e.selected=!1})),this._handleUserInitiatedToggle(!1)),this.value=r(this.querySelectorAll(this.constructor.selectorItem),(e=>e.selected)).map((e=>e.value)).join(",")}_handleClickInner(e){var t,s,i,o;(null===(t=this._selectionButtonNode)||void 0===t?void 0:t.contains(e.target))&&!this.readOnly?(this._handleUserInitiatedSelectItem(),this.filterable?this._filterInputNode.focus():this._triggerNode.focus()):(null===(s=this._clearButtonNode)||void 0===s?void 0:s.contains(e.target))?this._handleUserInitiatedClearInput():(null===(i=e.target)||void 0===i?void 0:i.matches(this.constructor.aiLabelItem))||(null===(o=e.target)||void 0===o?void 0:o.matches(this.constructor.slugItem))||(super._handleClickInner(e),this.filterable&&this._filterInputNode.focus())}_handleKeypressInner(e){var t,s;const{key:i}=e,o=this.constructor.getAction(i),{TRIGGERING:c}=p;!(null===(t=this._clearButtonNode)||void 0===t?void 0:t.contains(e.target))||o!==c&&" "!==i?(null===(s=this._selectionButtonNode)||void 0===s?void 0:s.contains(e.target))?(this._handleUserInitiatedSelectItem(),this.open=!0,this.filterable?this._filterInputNode.focus():this._triggerNode.focus()):this.filterable?this._handleKeypressInnerFlterable(e):super._handleKeypressInner(e):this._handleUserInitiatedClearInput()}_handleKeypressInnerFlterable(e){const{key:t}=e,s=this.constructor.getAction(t);if(this.open){if("Enter"===t){const e=this.constructor,t=this.querySelector(e.selectorItemHighlighted);t?this._handleUserInitiatedSelectItem(t):this._handleUserInitiatedToggle(!1)}}else if(s===p.TRIGGERING)this._handleUserInitiatedToggle(!0)}_renderTitleLabel(){const{clearSelectionDescription:e,clearSelectionText:t,disabled:o,hideLabel:c,titleText:l,_selectedItemsCount:a,_slotTitleTextNode:r,_handleSlotchangeLabelText:n}=this,b=d({[`${i}--label`]:!0,[`${i}--label--disabled`]:o,[`${i}--visually-hidden`]:c}),p=l||r&&r.assignedNodes().length>0;return s`
      <label
        part="title-text"
        class="${b}"
        ?hidden="${!p}">
        ...
        >
        ${a>0?s`
              <span class="${i}--visually-hidden">
                ${e} ${a},
                ${t}
              </span>
            `:null}
      </label>
    `}_renderPrecedingLabel(){const{disabled:e,readOnly:t,clearSelectionLabel:o,_selectedItemsCount:c}=this,a=d({[`${i}--list-box__selection`]:!0,[`${i}--list-box__selection--multi`]:!0,[`${i}--tag`]:!0,[`${i}--tag--filter`]:!0,[`${i}--tag--high-contrast`]:!0,[`${i}--tag--disabled`]:e});return 0===c?void 0:s`
          <div
            id="selection-button"
            role="button"
            class="${a}"
            ...
            title="${o}">
            ${c}
            ${l({"aria-label":o,class:`${i}--tag__close-icon`})}
          </div>
        `}_renderLabel(){const{label:e,value:t,_selectedItemContent:o}=this,c=d({[`${i}--text-input`]:!0,[`${i}--text-input--empty`]:!t});return this.filterable?s`
          <input
            id="trigger-label"
            class="${c}"
            placeholder="${e}"
        ...
        `:s`
          <span id="trigger-label" class="${i}--list-box__label"
            >${o||e}</span
          >
        `}_renderFollowingLabel(){const{clearSelectionLabel:e,_filterInputNode:t}=this;return t&&t.value.length>0&&this.filterable?s`
          <div
            id="clear-button"
            role="button"
            class="${i}--list-box__selection"
            tabindex="0"
            title="${e}">
            ${l({"aria-label":e})}
          </div>
        `:void 0}_handleInput(){const e=this.querySelectorAll(this.constructor.selectorItem),t=this._filterInputNode.value.toLocaleLowerCase();this.open||(this.open=!0),a(e,(e=>{e.innerText.toLocaleLowerCase().includes(t)?e.removeAttribute("filtered"):(e.setAttribute("filtered",""),e.removeAttribute("highlighted"))})),this.requestUpdate()}_navigate(e){if(this.filterable){const t=this.constructor,s=this.querySelectorAll(t.selectorItemResults),i=this.querySelector(t.selectorItemHighlighted);let o=n(s,i)+e;o<0&&(o=s.length-1),o>=s.length&&(o=0),a(s,((e,t)=>{e.highlighted=t===o}))}else super._navigate(e)}_handleUserInitiatedClearInput(){const e=this.constructor,t=this.querySelectorAll(e.selectorItemFiltered);this._filterInputNode.value="",this.open=!0,this._filterInputNode.focus(),a(t,(e=>{e.removeAttribute("filtered")}))}get _classes(){const{disabled:e,size:t,type:s,invalid:o,readOnly:c,open:l,warn:a,_selectedItemsCount:r}=this,n=s===u.INLINE;return d({[`${i}--multi-select`]:!0,[`${i}--list-box`]:!0,[`${i}--list-box--disabled`]:e,[`${i}--list-box--inline`]:n,[`${i}--list-box--expanded`]:l,[`${i}--list-box--${t}`]:t,[`${i}--multi-select--invalid`]:o,[`${i}--multi-select--warn`]:a,[`${i}--multi-select--inline`]:n,[`${i}--multi-select--readonly`]:c,[`${i}--multi-select--selected`]:r>0})}shouldUpdate(e){const{selectorItem:t,aiLabelItem:s,slugItem:i}=this.constructor,o=this.querySelector(s)||this.querySelector(i),c=this.querySelectorAll(t),{value:d,locale:l}=this,n=d?d.split(","):[];if(e.has("size")&&a(this.querySelectorAll(t),(e=>{e.size=this.size})),e.has("value")&&(a(c,(e=>{e.selected=n.indexOf(e.value)>=0})),this._selectedItemsCount=r(c,(e=>n.indexOf(e.value)>=0)).length,this.selectionFeedback===x.TOP)){const e=this.sortItems(c,{values:n,compareItems:this.compareItems,locale:l});o&&e.unshift(o),this.replaceChildren(...e)}if(e.has("open")&&this.selectionFeedback===x.TOP_AFTER_REOPEN){const e=this.sortItems(c,{values:n,compareItems:this.compareItems,locale:l});o&&e.unshift(o),this.replaceChildren(...e)}return!0}updated(e){super.updated(e),e.has("open")&&this.open&&!this.filterable&&this._menuBodyNode.focus()}connectedCallback(){super.connectedCallback(),this.value=r(this.querySelectorAll(this.constructor.selectorItem),(e=>e.selected)).map((e=>e.value)).join(",")}static get selectorMenuBody(){return'div[part="menu-body"]'}static get selectorItemHighlighted(){return`${i}-multi-select-item[highlighted]`}static get selectorItem(){return`${i}-multi-select-item`}static get selectorItemFiltered(){return`${i}-multi-select-item[filtered]`}static get selectorItemResults(){return`${i}-multi-select-item:not([filtered])`}static get selectorItemSelected(){return`${i}-multi-select-item[selected]`}static get eventBeforeToggle(){return`${i}-multi-select-beingtoggled`}static get eventToggle(){return`${i}-multi-select-toggled`}static get eventBeforeSelect(){return`${i}-multi-select-beingselected`}static get eventSelect(){return`${i}-multi-select-selected`}};f.styles=h,t([o({type:Boolean})],f.prototype,"filterable",void 0),t([c("#clear-button")],f.prototype,"_clearButtonNode",void 0),t([c("#selection-button")],f.prototype,"_selectionButtonNode",void 0),t([c("#menu-body")],f.prototype,"_menuBodyNode",void 0),t([c("input")],f.prototype,"_filterInputNode",void 0),t([c(`.${i}--list-box__field`)],f.prototype,"_triggerNode",void 0),t([o({attribute:"clear-selection-label"})],f.prototype,"clearSelectionLabel",void 0),t([o({attribute:"clear-selection-description"})],f.prototype,"clearSelectionDescription",void 0),t([o({attribute:"clear-selection-text"})],f.prototype,"clearSelectionText",void 0),t([o()],f.prototype,"locale",void 0),t([o({attribute:"selection-feedback"})],f.prototype,"selectionFeedback",void 0),f=t([g(`${i}-multi-select`)],f);
/**
 * @license
 *
 ...
 * LICENSE file in the root directory of this source tree.
 */
let v=class extends m{constructor(){super(...arguments),this.selectionName=""}render(){const{disabled:e,selected:t,selectionName:o,value:c}=this;return s`
      <div class="${i}--list-box__menu-item__option">
        <div class="${i}--form-item ${i}--checkbox-wrapper">
          <span
            value="${c}"
            name="${_(o||void 0)}"
            class="${i}--checkbox-label"
            ?disabled=${e}
            data-contained-checkbox-state=${t}
            ><slot></slot
          ></span>
        </div>
      </div>
    `}static get selectorList(){return`${i}-multi-select`}};v.styles=h,t([o({type:Boolean})],v.prototype,"filtered",void 0),t([o({attribute:"selection-name"})],v.prototype,"selectionName",void 0),v=t([g(`${i}-multi-select-item`)],v);
