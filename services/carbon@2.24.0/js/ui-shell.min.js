 ...
 * This source code is licensed under the Apache-2.0 license found in the
 * LICENSE file in the root directory of this source tree.
 */let x=class extends s{connectedCallback(){this.hasAttribute("role")||this.setAttribute("role","banner"),super.connectedCallback()}render(){return o` <slot></slot> `}};x.styles=y,x=t([i(`${d}-header`)],x);
/**
 * @license
 *
 ...
 * LICENSE file in the root directory of this source tree.
 */
let z=class extends a{connectedCallback(){this.tooltipPosition=l.BOTTOM,super.connectedCallback()}_handleClick(e){const{disabled:t}=this;if(t)e.stopPropagation();else{const e=document.querySelector(`#${this.panelId}`);if(e){e.getAttribute("expanded")?e.removeAttribute("expanded"):e.setAttribute("expanded","true");const t=!this.active;this.active=t}}}updated(){this._buttonNode&&this._buttonNode.classList.add(`${d}--header__action`)}shouldUpdate(e){return e.has("active")&&(this.active?(this._buttonNode.classList.add(`${d}--header__action--active`),this.buttonLabelActive&&(this.tooltipText=this.buttonLabelActive)):(this._buttonNode.classList.remove(`${d}--header__action--active`),this.buttonLabelInactive&&(this.tooltipText=this.buttonLabelInactive))),!0}};z.shadowRootOptions=Object.assign(Object.assign({},s.shadowRootOptions),{delegatesFocus:!0}),z.styles=y,t([c("button")],z.prototype,"_buttonNode",void 0),t([r({type:Boolean,reflect:!0})],z.prototype,"active",void 0),t([r({type:String,attribute:"panel-id",reflect:!0})],z.prototype,"panelId",void 0),t([r({attribute:"button-label-active"})],z.prototype,"buttonLabelActive",void 0),t([r({attribute:"button-label-inactive"})],z.prototype,"buttonLabelInactive",void 0),t([p("click",{capture:!0})],z.prototype,"_handleClick",null),z=t([i(`${d}-header-global-action`)],z);
/**
 * @license
 *
 ...
 * LICENSE file in the root directory of this source tree.
 */
let k=class extends(v(b(s))){constructor(){super(...arguments),this._hasActiveChildren=!1,this.expanded=!1,this.isActive=!1,this.triggerContent=""}_handleClick(){this._handleUserInitiatedToggle()}_handleKeydownTrigger({key:e}){"Esc"!==e&&"Escape"!==e||this._handleUserInitiatedToggle(!1)}_handleUserInitiatedToggle(e=!this.expanded){this.expanded=e,e||this._topMenuItem.focus()}_handleBlur({relatedTarget:e}){this.contains(e)||(this.expanded=!1)}connectedCallback(){this.hasAttribute("role")||this.setAttribute("role","listitem");const{selectorItem:e}=this.constructor;m(this.querySelectorAll(e),(e=>{!0===e.isActive&&(this._hasActiveChildren=!0)})),super.connectedCallback()}updated(e){if(e.has("expanded")){const{selectorItem:e}=this.constructor,{expanded:t}=this;m(this.querySelectorAll(e),(e=>{e.tabIndex=t?0:-1}))}}render(){const{expanded:e,isActive:t,triggerContent:s,menuLabel:n,_hasActiveChildren:i,_handleClick:r}=this,c=g({[`${d}--header__menu-item`]:!0,[`${d}--header__menu-title`]:!0,[`${d}--header__menu-item--current`]:t||i&&!e});return o`
      <a
        part="trigger"
        role="button"
        tabindex="0"
        ...
        @click=${r}>
        ${s}${u({part:"trigger-icon",class:`${d}--header__menu-arrow`})}
      </a>
      <ul
        part="menu-body"
        class="${d}--header__menu"
        aria-label="${h(n)}">
        <slot></slot>
      </ul>
    `}static get selectorItem(){return`${d}-header-menu-item`}};k.shadowRootOptions=Object.assign(Object.assign({},s.shadowRootOptions),{delegatesFocus:!0}),k.styles=y,t([c('[part="trigger"]')],k.prototype,"_topMenuItem",void 0),t([p("keydown")],k.prototype,"_handleKeydownTrigger",null),t([p("focusout")],k.prototype,"_handleBlur",null),t([r({type:Boolean,reflect:!0})],k.prototype,"expanded",void 0),t([r({type:Boolean,attribute:"is-active",reflect:!0})],k.prototype,"isActive",void 0),t([r({attribute:"trigger-content"})],k.prototype,"triggerContent",void 0),t([r({attribute:"menu-label"})],k.prototype,"menuLabel",void 0),k=t([i(`${d}-header-menu`)],k);const w=({children:e,...t}={})=>n`<svg focusable="false" preserveAspectRatio="xMidYMid meet" xmlns="http://www.w3.org/2000/svg" fill="currentColor" ...="${_(t)}" aria-hidden="true" width="20" height="20" viewBox="0 0 20 20">${e}<path d="M2 14.8H18V16H2zM2 11.2H18V12.399999999999999H2zM2 7.6H18V8.799999999999999H2zM2 4H18V5.2H2z"></path></svg>`
/**
 * @license
 *
 ...
 * This source code is licensed under the Apache-2.0 license found in the
 * LICENSE file in the root directory of this source tree.
 */let I=class extends(v(s)){constructor(){super(...arguments),this._hovered=!1,this._hTransition=null,this._handleButtonToggle=async e=>{this.expanded=e.detail.active},this.collapseMode=$.RESPONSIVE,this.expanded=!1,this.isNotChildOfHeader=!1,this.isNotPersistent=!1}_cleanHTransition(){this._hTransition&&(this._hTransition=this._hTransition.release())}_updatedSideNavMenuForceCollapsedState(){const{expanded:e,_hovered:t}=this;m(this.querySelectorAll(this.constructor.selectorMenu),(s=>{s.forceCollapsed=!e&&!t}))}connectedCallback(){this.hasAttribute("role")||this.setAttribute("role","navigation"),super.connectedCallback()}disconnectedCallback(){this._cleanHTransition(),super.disconnectedCallback()}updated(e){var t;const s=this.getRootNode();if(e.has("collapseMode")&&m(s.querySelectorAll(this.constructor.selectorButtonToggle),(e=>{e.collapseMode=this.collapseMode})),e.has("expanded")){const e=s.querySelectorAll(this.constructor.selectorHeaderItems);m(s.querySelectorAll(this.constructor.selectorButtonToggle),(e=>{e.active=this.expanded})),this.expanded?(m(e,(e=>{e.setAttribute("tabindex","-1")})),null===(t=this.querySelector(this.constructor.selectorNavItems))||void 0===t||t.focus()):m(e,(e=>{e.removeAttribute("tabindex")}))}e.has("isNotChildOfHeader")&&m(s.querySelectorAll(this.constructor.selectorButtonToggle),(e=>{e.isNotChildOfHeader=this.isNotChildOfHeader}))}_handleFocusOut({relatedTarget:e}){const{collapseMode:t}=this;t!==$.FIXED&&(this.contains(e)||(this.expanded=!1))}_handleFocusIn(){const{collapseMode:e}=this;e!==$.FIXED&&(this.expanded=!0)}_handleNavMouseOver(){const{collapseMode:e}=this;e===$.RAIL&&(this.expanded=!0,this._hovered=!0,this._updatedSideNavMenuForceCollapsedState())}_handleNavMouseOut(){const{collapseMode:e}=this;e===$.RAIL&&(this.expanded=!1,this._hovered=!1,this._updatedSideNavMenuForceCollapsedState())}_onOverlayClick(){this.expanded=!1}render(){const{collapseMode:e,expanded:t,isNotChildOfHeader:s,isNotPersistent:n}=this,i=g({[`${d}--side-nav__navigation`]:!0,[`${d}--side-nav`]:!0,[`${d}--side-nav--expanded`]:t,[`${d}--side-nav--collapsed`]:!t&&e===$.FIXED,[`${d}--side-nav--rail`]:e===$.RAIL,[`${d}--side-nav--ux`]:!s,[`${d}--side-nav--hidden`]:n}),r=g({[`${d}--side-nav__overlay`]:!0,[`${d}--side-nav__overlay-active`]:t});return o`${this.collapseMode===$.FIXED?null:o`<div
            class="${r}"
      ...
      <div
        ...
        <slot></slot>
      </div>`}static get selectorButtonToggle(){return`${d}-header-menu-button`}static get selectorHeaderItems(){return`${d}-header-name, ${d}-header-global-action`}static get selectorNavItems(){return`${d}-side-nav-menu, ${d}-side-nav-menu-item, ${d}-side-nav-link`}static get selectorMenu(){return`${d}-side-nav-menu`}static get eventButtonToggle(){return`${d}-header-menu-button-toggled`}};I.styles=A,t([p("parentRoot:eventButtonToggle")],I.prototype,"_handleButtonToggle",void 0),t([r({reflect:!0,attribute:"collapse-mode"})],I.prototype,"collapseMode",void 0),t([r({type:Boolean,reflect:!0})],I.prototype,"expanded",void 0),t([r({type:Boolean,attribute:"is-not-child-of-header"})],I.prototype,"isNotChildOfHeader",void 0),t([r({type:Boolean,reflect:!0,attribute:"is-not-persistent"})],I.prototype,"isNotPersistent",void 0),t([p("focusout")],I.prototype,"_handleFocusOut",null),t([p("focusin")],I.prototype,"_handleFocusIn",null),I=t([i(`${d}-side-nav`)],I);
/**
 * @license
 *
 * Copyright IBM Corp. 2019, 2023
 ...
 * LICENSE file in the root directory of this source tree.
 */
let O=class extends(b(s)){constructor(){super(...arguments),this.active=!1,this.buttonLabelActive="Close navigation menu",this.buttonLabelInactive="Open navigation menu",this.collapseMode=$.RESPONSIVE,this.disabled=!1,this.isNotChildOfHeader=!1}_handleClick(){const e=!this.active;this.active=e,this.dispatchEvent(new CustomEvent(this.constructor.eventToggle,{bubbles:!0,cancelable:!0,composed:!0,detail:{active:e}}))}render(){const{active:e,buttonLabelActive:t,buttonLabelInactive:s,disabled:n,_handleClick:i}=this,r=e?t:s,c=g({[`${d}--header__action`]:!0,[`${d}--header__menu-trigger`]:!0,[`${d}--header__menu-toggle`]:!0,[`${d}--header__action--active`]:e});return o`
      <button
        part="button"
        class="${c}"
        ?disabled=${n}
        aria-label="${h(r)}"
        @click=${i}>
        ${(e?f:w)({slot:"toggle-icon"})}
      </button>
    `}static get eventToggle(){return`${d}-header-menu-button-toggled`}};O.shadowRootOptions=Object.assign(Object.assign({},s.shadowRootOptions),{delegatesFocus:!0}),O.styles=y,t([r({type:Boolean,reflect:!0})],O.prototype,"active",void 0),t([r({attribute:"button-label-active"})],O.prototype,"buttonLabelActive",void 0),t([r({attribute:"button-label-inactive"})],O.prototype,"buttonLabelInactive",void 0),t([r({reflect:!0,attribute:"collapse-mode"})],O.prototype,"collapseMode",void 0),t([r({type:Boolean,reflect:!0})],O.prototype,"disabled",void 0),t([r({type:Boolean,attribute:"is-not-child-of-header"})],O.prototype,"isNotChildOfHeader",void 0),O=t([i(`${d}-header-menu-button`)],O);
/**
 * @license
 *
 * Copyright IBM Corp. 2019, 2024
 ...
 * LICENSE file in the root directory of this source tree.
 */
let S=class extends(b(s)){constructor(){super(...arguments),this.isActive=!1,this.role="listitem"}render(){const{ariaCurrent:e,href:t,isActive:s,title:n,rel:i,target:r}=this,c=g({[`${d}--header__menu-item`]:!0,[`${d}--header__menu-item--current`]:s&&"page"!==e});return o`
      <a
        part="link"
        class="${c}"
        tabindex="0"
        ...
        rel="${h(i)}"
        target="${h(r)}">
        <span part="title" class="${d}--text-truncate--end"
          ><slot>${n}</slot></span
        >
      </a>
    `}};S.shadowRootOptions=Object.assign(Object.assign({},s.shadowRootOptions),{delegatesFocus:!0}),S.styles=y,t([r()],S.prototype,"href",void 0),t([r({reflect:!0})],S.prototype,"rel",void 0),t([r({reflect:!0})],S.prototype,"target",void 0),t([r()],S.prototype,"title",void 0),t([r({type:Boolean,attribute:"is-active"})],S.prototype,"isActive",void 0),t([r({type:String,attribute:"aria-current"})],S.prototype,"ariaCurrent",void 0),t([r({reflect:!0})],S.prototype,"role",void 0),S=t([i(`${d}-header-nav-item`)],S);var B=S;
/**
 * @license
 *
 * Copyright IBM Corp. 2019, 2023
 ...
 * This source code is licensed under the Apache-2.0 license found in the
 * LICENSE file in the root directory of this source tree.
 */let M=class extends B{};M=t([i(`${d}-header-menu-item`)],M);
/**
 * @license
 *
 * Copyright IBM Corp. 2019, 2023
 ...
 * LICENSE file in the root directory of this source tree.
 */
let N=class extends(b(s)){render(){const{href:e,prefix:t}=this,s=t?o`
          <span part="prefix" class="${d}--header__name--prefix"
            >${t}</span
          >
        `:void 0;return o`
      <a part="link" class="${d}--header__name" href="${h(e)}"
        >${s}&nbsp;<slot></slot
      ></a>
    `}};N.shadowRootOptions=Object.assign(Object.assign({},s.shadowRootOptions),{delegatesFocus:!0}),N.styles=y,t([r()],N.prototype,"href",void 0),t([r()],N.prototype,"prefix",void 0),N=t([i(`${d}-header-name`)],N);
/**
 * @license
 *
 * Copyright IBM Corp. 2019, 2023
 ...
 * LICENSE file in the root directory of this source tree.
 */
let T=class extends s{connectedCallback(){this.hasAttribute("role")||this.setAttribute("role","navigation"),super.connectedCallback()}render(){const{menuBarLabel:e}=this;return o`
      <div part="divider" class="${d}-ce--header__divider"></div>
      <ul
        part="menu-body"
        class="${d}--header__menu-bar"
        aria-label="${e}">
        <slot></slot>
      </ul>
    `}};T.styles=y,t([r({attribute:"menu-bar-label"})],T.prototype,"menuBarLabel",void 0),T=t([i(`${d}-header-nav`)],T);
/**
 * @license
 *
 * Copyright IBM Corp. 2023, 2024
 ...
 * LICENSE file in the root directory of this source tree.
 */
let j=class extends s{render(){return o`<slot></slot>`}};j.shadowRootOptions=Object.assign(Object.assign({},s.shadowRootOptions),{delegatesFocus:!0}),j.styles=y,t([r({type:Boolean,reflect:!0})],j.prototype,"expanded",void 0),j=t([i(`${d}-header-panel`)],j);
/**
 * @license
 *
 * Copyright IBM Corp. 2023, 2024
 ...
 * LICENSE file in the root directory of this source tree.
 */
let R=class extends s{constructor(){super(...arguments),this.hasDivider=!1}connectedCallback(){this.hasAttribute("role")||this.setAttribute("role","list"),super.connectedCallback()}render(){return o`<slot></slot>`}};R.styles=A,t([r({type:Boolean,attribute:"has-divider"})],R.prototype,"hasDivider",void 0),R=t([i(`${d}-header-side-nav-items`)],R);
/**
 * @license
 *
 ...
 * LICENSE file in the root directory of this source tree.
 */
let F=class extends s{connectedCallback(){this.hasAttribute("role")||this.setAttribute("role","separator"),super.connectedCallback()}};F.styles=A,F=t([i(`${d}-side-nav-divider`)],F);
/**
 * @license
 *
 * Copyright IBM Corp. 2019, 2023
 ...
 * LICENSE file in the root directory of this source tree.
 */
let q=class extends s{connectedCallback(){this.hasAttribute("role")||this.setAttribute("role","list"),super.connectedCallback()}render(){return o`<slot></slot>`}};q.styles=A,q=t([i(`${d}-side-nav-items`)],q);
/**
 * @license
 *
 * Copyright IBM Corp. 2019, 2023
 ...
 * LICENSE file in the root directory of this source tree.
 */
let L=class extends(b(s)){constructor(){super(...arguments),this.active=!1,this.href="",this.large=!1}_handleSlotChangeTitleIcon({target:e}){var t;null===(t=this._titleIconContainerNode)||void 0===t||t.toggleAttribute("hidden",0===e.assignedNodes().length)}connectedCallback(){this.hasAttribute("role")||this.setAttribute("role","listitem"),super.connectedCallback()}render(){const{active:e,href:t,rel:s,target:n,title:i,_handleSlotChangeTitleIcon:r}=this,c=g({[`${d}--side-nav__link`]:!0,[`${d}--side-nav__link--current`]:e});return o`
      <a
        part="link"
        class="${c}"
        href="${t}"
        ...
        <div
          ...
          hidden
          class="${d}--side-nav__icon">
          <slot
            name="title-icon"
            @slotchange=${r}></slot>
        </div>
        <span part="title" class="${d}--side-nav__link-text">
          <slot>${i}</slot>
        </span>
      </a>
    `}};L.shadowRootOptions=Object.assign(Object.assign({},s.shadowRootOptions),{delegatesFocus:!0}),L.styles=A,t([c("#title-icon-container")],L.prototype,"_titleIconContainerNode",void 0),t([r({type:Boolean,reflect:!0})],L.prototype,"active",void 0),t([r()],L.prototype,"href",void 0),t([r({reflect:!0})],L.prototype,"rel",void 0),t([r({reflect:!0})],L.prototype,"target",void 0),t([r({type:Boolean,reflect:!0})],L.prototype,"large",void 0),t([r()],L.prototype,"title",void 0),L=t([i(`${d}-side-nav-link`)],L);
/**
 * @license
 *
 * Copyright IBM Corp. 2019, 2024
 ...
 * LICENSE file in the root directory of this source tree.
 */
let E=class extends(b(s)){constructor(){super(...arguments),this._hasIcon=!1,this.active=!1,this.expanded=!1,this.large=!1,this.forceCollapsed=!1,this.title=""}_handleUserInitiatedToggle(e=!this.expanded){const{eventBeforeToggle:t,eventToggle:s}=this.constructor,o={bubbles:!0,cancelable:!0,composed:!0,detail:{expanded:e}};this.dispatchEvent(new CustomEvent(t,o))&&(this.expanded=e,this.dispatchEvent(new CustomEvent(s,o)))}_handleClickExpando(){this._handleUserInitiatedToggle()}_handleSlotChange({target:e}){const{_hasIcon:t}=this;m(e.assignedNodes(),(e=>{e.nodeType===Node.ELEMENT_NODE&&e.toggleAttribute(this.constructor.attribItemHasIcon,t)}))}_handleSlotChangeTitleIcon({target:e}){var t;const s=this.constructor,o=e.assignedNodes().length>0;this._hasIcon=o,null===(t=this._titleIconContainerNode)||void 0===t||t.toggleAttribute("hidden",!o),m(this.querySelectorAll(s.selectorItem),(e=>{e.toggleAttribute(s.attribItemHasIcon,o)}))}connectedCallback(){this.hasAttribute("role")||this.setAttribute("role","listitem"),super.connectedCallback()}updated(e){if(e.has("expanded")){const{selectorItem:e}=this.constructor,{expanded:t}=this;m(this.querySelectorAll(e),(e=>{e.tabIndex=t?0:-1}))}}render(){const{expanded:e,forceCollapsed:t,title:s,_handleClickExpando:i,_handleSlotChange:r,_handleSlotChangeTitleIcon:c}=this;return o`
      <button
        type="button"
        part="expando"
        aria-haspopup="true"
        aria-expanded="${String(Boolean(e&&!t))}"
        class="${d}--side-nav__submenu"
        @click=${i}>
        <div
          id="title-icon-container"
          part="title-icon-container"
        ...
        <span part="title" class="${d}--side-nav__submenu-title"
          >${s}</span
        >
        <div
          part="expando-icon-container"
          class="${d}--side-nav__icon ${d}--side-nav__icon--small ${d}--side-nav__submenu-chevron">
          ${(({children:e,...t}={})=>n`<svg focusable="false" preserveAspectRatio="xMidYMid meet" xmlns="http://www.w3.org/2000/svg" fill="currentColor" ...="${_(t)}" aria-hidden="true" width="20" height="20" viewBox="0 0 32 32">${e}<path d="M16 22L6 12 7.4 10.6 16 19.2 24.6 10.6 26 12z"></path></svg>`)({part:"expando-icon"})}
        </div>
      </button>
      <ul part="menu-body" class="${d}--side-nav__menu">
        <slot @slotchange=${r}></slot>
      </ul>
    `}static get selectorItem(){return`${d}-side-nav-menu-item`}static get eventBeforeToggle(){return`${d}-side-nav-menu-beingtoggled`}static get eventToggle(){return`${d}-side-nav-menu-toggled`}};E.attribItemHasIcon="parent-has-icon",E.shadowRootOptions=Object.assign(Object.assign({},s.shadowRootOptions),{delegatesFocus:!0}),E.styles=A,t([c("#title-icon-container")],E.prototype,"_titleIconContainerNode",void 0),t([r({type:Boolean,reflect:!0})],E.prototype,"active",void 0),t([r({type:Boolean,reflect:!0})],E.prototype,"expanded",void 0),t([r({type:Boolean,reflect:!0})],E.prototype,"large",void 0),t([r({type:Boolean,reflect:!0,attribute:"force-collapsed"})],E.prototype,"forceCollapsed",void 0),t([r()],E.prototype,"title",void 0),E=t([i(`${d}-side-nav-menu`)],E);
/**
 * @license
 *
 * Copyright IBM Corp. 2019, 2023
 ...
 * LICENSE file in the root directory of this source tree.
 */
let H=class extends(b(s)){constructor(){super(...arguments),this.active=!1,this.href=""}shouldUpdate(e){if(e.has("active")&&this.active){const{selectorMenu:e}=this.constructor,t=this.closest(e);t&&(t.active=!0)}return!0}connectedCallback(){this.hasAttribute("role")||this.setAttribute("role","button"),super.connectedCallback()}render(){const{active:e,href:t,title:s}=this,n=g({[`${d}--side-nav__link`]:!0,[`${d}--side-nav__link--current`]:e});return o`
      <a part="link" class="${n}" href="${t}">
        <span part="title" class="${d}--side-nav__link-text">
          <slot>${s}</slot>
        </span>
      </a>
    `}static get selectorMenu(){return`${d}-side-nav-menu`}};H.shadowRootOptions=Object.assign(Object.assign({},s.shadowRootOptions),{delegatesFocus:!0}),H.styles=A,t([r({type:Boolean,reflect:!0})],H.prototype,"active",void 0),t([r()],H.prototype,"href",void 0),t([r()],H.prototype,"title",void 0),H=t([i(`${d}-side-nav-menu-item`)],H);
/**
 * @license
 *
 * Copyright IBM Corp. 2023, 2024
 ...
 * LICENSE file in the root directory of this source tree.
 */
let X=class extends s{connectedCallback(){this.hasAttribute("role")||this.setAttribute("role","list"),super.connectedCallback()}render(){return o`<slot></slot>`}};X.shadowRootOptions=Object.assign(Object.assign({},s.shadowRootOptions),{delegatesFocus:!0}),X.styles=y,t([r({type:String,attribute:"aria-label"})],X.prototype,"ariaLabel",void 0),t([r({type:String,attribute:"aria-labelledby"})],X.prototype,"ariaLabelledBy",void 0),X=t([i(`${d}-switcher`)],X);
/**
 * @license
 *
 * Copyright IBM Corp. 2023, 2024
 ...
 * LICENSE file in the root directory of this source tree.
 */
let P=class extends s{connectedCallback(){this.hasAttribute("role")||this.setAttribute("role","separator"),super.connectedCallback()}};P.styles=y,P=t([i(`${d}-switcher-divider`)],P);
/**
 * @license
 *
 * Copyright IBM Corp. 2019, 2024
 ...
 * LICENSE file in the root directory of this source tree.
 */
let D=class extends(b(s)){constructor(){super(...arguments),this.href="",this.selected=!1,this.tabIndex=0}connectedCallback(){this.hasAttribute("role")||this.setAttribute("role","listitem"),super.connectedCallback()}render(){const{href:e,selected:t,ariaLabel:s,ariaLabelledBy:n,tabIndex:i}=this,r=g({[`${d}--switcher__item-link`]:!0,[`${d}--switcher__item-link--selected`]:t});return o`
      <a
        part="link"
        aria-label="${s}"
        aria-labelledby="${n}"
    ...
    `}};D.shadowRootOptions=Object.assign(Object.assign({},s.shadowRootOptions),{delegatesFocus:!0}),D.styles=y,t([r({type:String,attribute:"aria-label"})],D.prototype,"ariaLabel",void 0),t([r({type:String,attribute:"aria-labelledby"})],D.prototype,"ariaLabelledBy",void 0),t([r()],D.prototype,"href",void 0),t([r({type:Boolean,reflect:!0})],D.prototype,"selected",void 0),t([r({type:Number,reflect:!0,attribute:"tab-index"})],D.prototype,"tabIndex",void 0),D=t([i(`${d}-switcher-item`)],D);
