...
import{b as e,i as t,r as n,_ as s,p as i,x as r}from"./settings-a9cb5e4b.js";import{n as d}from"./property-4de26c93.js";import{e as o}from"./query-602de8af.js";import{e as a}from"./class-map-e4ba9e2b.js";import{s as c}from"./16-8449b4fa.js";import{s as l}from"./16-b826e67b.js";import{s as u}from"./spread-279bf949.js";import{i as p}from"./if-non-empty-0ab1b89b.js";import"./shared-enums-562e6b51.js";import{C as m,I as b}from"./text-input-1067f3fd.js";import{c as h}from"./carbon-element-017b212d.js";import"./directive-e2d48b9c.js";import"./if-defined-446d5754.js";import"./form-a750a2ac.js";import"./on-8707857f.js";import"./validity-45b7794a.js";
/**
 * @license
 *
 ...
 * This source code is licensed under the Apache-2.0 license found in the
 * LICENSE file in the root directory of this source tree.
 */let _=class extends m{constructor(){super(...arguments),this._min="",this._max="",this._step="1",this.incrementButtonAssistiveText="increase number input",this.decrementButtonAssistiveText="decrease number input",this.hideSteppers=!1,this.allowEmpty=!1,this.size=b.MEDIUM}_handleInput(e){const{target:t}=e,{value:n}=t;this.dispatchEvent(new CustomEvent(this.constructor.eventInput,{bubbles:!0,composed:!0,cancelable:!1,detail:{value:n}})),super._handleInput(e)}_handleUserInitiatedStepDown(e){const{_input:t}=this;this.stepDown(),this.dispatchEvent(new CustomEvent(this.constructor.eventInput,{bubbles:!0,composed:!0,cancelable:!1,detail:{value:t.value}}))}_handleUserInitiatedStepUp(e){const{_input:t}=this;this.stepUp(),this.dispatchEvent(new CustomEvent(this.constructor.eventInput,{bubbles:!0,composed:!0,cancelable:!1,detail:{value:t.value}}))}_getInputValidity(){var e,t;return!this.invalid&&(!((null===(e=this._input)||void 0===e?void 0:e.valueAsNumber)>Number(this.max)||(null===(t=this._input)||void 0===t?void 0:t.valueAsNumber)<Number(this.min))&&(""!==this.value||this.allowEmpty))}get min(){return this._min.toString()}set min(e){const t=this.min;this._min=e,this.requestUpdate("min",t)}get max(){return this._max.toString()}set max(e){const t=this.max;this._max=e,this.requestUpdate("max",t)}get step(){return this._step.toString()}set step(e){const t=this.step;this._step=e,this.requestUpdate("step",t)}stepUp(){this._input.stepUp()}stepDown(){this._input.stepDown()}render(){const{_handleInput:t,_handleUserInitiatedStepDown:n,_handleUserInitiatedStepUp:s}=this,d=this._getInputValidity(),o=c({class:`${i}--number__invalid`}),m=l({class:`${i}--number__invalid ${i}--number__invalid--warning`}),b={disabled:!this.readonly&&this.disabled,invalid:!this.readonly&&!d,warn:!this.readonly&&d&&this.warn,"slot-name":"","slot-text":"",icon:null},h=a({[`${i}--number`]:!0,[`${i}--number--${this.size}`]:this.size,[`${i}--number--nosteppers`]:this.hideSteppers,[`${i}--number--readonly`]:this.readonly}),g=a({[`${i}--number__input-wrapper`]:!0,[`${i}--number__input-wrapper--warning`]:b.warn,[`${i}--number__input-wrapper--slug`]:this._hasAILabel}),f=a({[`${i}--label`]:!0,[`${i}--label--disabled`]:b.disabled,[`${i}--visually-hidden`]:this.hideLabel}),_=a({[`${i}--form__helper-text`]:!0,[`${i}--form__helper-text--disabled`]:b.disabled}),v=r`
      <button
        class="${i}--number__control-btn up-icon"
        ...
        ?disabled=${b.disabled}
        @click=${s}>
        ${(({children:t,...n}={})=>e`<svg focusable="false" preserveAspectRatio="xMidYMid meet" xmlns="http://www.w3.org/2000/svg" fill="currentColor" ...="${u(n)}" aria-hidden="true" width="16" height="16" viewBox="0 0 32 32">${t}<path d="M17 15L17 8 15 8 15 15 8 15 8 17 15 17 15 24 17 24 17 17 24 17 24 15z"></path></svg>`)()}
      </button>
      <div class="${i}--number__rule-divider"></div>
    `,y=r`
      <button
        class="${i}--number__control-btn down-icon"
        ...
        ?disabled=${b.disabled}
        @click=${n}>
        ${(({children:t,...n}={})=>e`<svg focusable="false" preserveAspectRatio="xMidYMid meet" xmlns="http://www.w3.org/2000/svg" fill="currentColor" ...="${u(n)}" aria-hidden="true" width="16" height="16" viewBox="0 0 32 32">${t}<path d="M8 15H24V17H8z"></path></svg>`)()}
      </button>
      <div class="${i}--number__rule-divider"></div>
    `,x=r`
      <input
        ...
        role="alert"
        aria-atomic="true" />
    `;return b.invalid?(b.icon=o,b["slot-name"]="invalid-text",b["slot-text"]=this.invalidText):b.warn&&(b.icon=m,b["slot-name"]="warn-text",b["slot-text"]=this.warnText),r`
      <div class="${h}" ?data-invalid=${b.invalid}>
        ...
        <div class="${g}">
          ...
          <div class="${i}--number__controls">
            ${this.hideSteppers?null:r`${y} ${v}`}
          </div>
        </div>
        <div
          class="${_}"
    ...
    `}static get eventInput(){return`${i}-number-input`}};_.shadowRootOptions=Object.assign(Object.assign({},n.shadowRootOptions),{delegatesFocus:!0}),_.styles=f,s([o("input")],_.prototype,"_input",void 0),s([d({reflect:!0})],_.prototype,"min",null),s([d({reflect:!0})],_.prototype,"max",null),s([d({reflect:!0})],_.prototype,"step",null),s([d({attribute:"increment-button-assistive-text"})],_.prototype,"incrementButtonAssistiveText",void 0),s([d({attribute:"decrement-button-assistive-text"})],_.prototype,"decrementButtonAssistiveText",void 0),s([d({type:Boolean,attribute:"hide-steppers",reflect:!0})],_.prototype,"hideSteppers",void 0),s([d({type:Boolean,attribute:"allow-empty",reflect:!0})],_.prototype,"allowEmpty",void 0),s([d({reflect:!0})],_.prototype,"size",void 0),_=s([h(`${i}-number-input`)],_);
/**
 * @license
 *
 ...
 * LICENSE file in the root directory of this source tree.
 */
let v=class extends n{constructor(){super(...arguments),this.hideLabel=!1}render(){const{hideLabel:e}=this;return r`
      ${!e&&r` <span class="${i}--label ${i}--skeleton"></span> `}
      <div class="${i}--number ${i}--skeleton"></div>
    `}};v.styles=f,s([d({type:Boolean,reflect:!0,attribute:"hide-label"})],v.prototype,"hideLabel",void 0),v=s([h(`${i}-number-input-skeleton`)],v);
