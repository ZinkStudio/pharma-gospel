...
import{i as e,_ as o,r as t,p as n,x as s}from"./settings-a9cb5e4b.js";import{e as i}from"./class-map-e4ba9e2b.js";import{n as r}from"./property-4de26c93.js";import{c as a}from"./carbon-element-017b212d.js";
/**
 * @license
 *
 ...
 * This source code is licensed under the Apache-2.0 license found in the
 * LICENSE file in the root directory of this source tree.
 */function d(e,o,t){return Math.floor([.973051493507435,.15334737213558558,.5671034553053769][t%3]*(o-e+1))+e}let p=class extends t{constructor(){super(...arguments),this.type=c.REGULAR,this.width="100%",this.paragraph=!1,this.lineCount=3}render(){const{optionalClasses:e,paragraph:o,lineCount:t,type:r,width:a}=this;let l={[`${n}--skeleton__text`]:!0,[`${n}--skeleton__heading`]:r===c.HEADING};if(e){const o={};null==e||e.split(" ").forEach((e=>{o[e]=!0})),l=Object.assign(Object.assign({},l),o)}const p=i(l);if(o){const e=parseInt(this.width,10),o=this.width.includes("px"),n=this.width.includes("%"),i=[];for(let r=0;r<t;r++){const t=n&&`${d(0,75,r)}px`||o&&`${d(0,e,r)}px`,c=n&&`width: calc(${a} - ${t})`||o&&`width: ${t}`||"";i.push(s`<p class="${p}" style="${c}"></p>`)}return i}return s`<p class="${p}" style="width:${a}"></p>`}};p.styles=l,o([r({reflect:!0,attribute:"optional-classes"})],p.prototype,"optionalClasses",void 0),o([r({reflect:!0})],p.prototype,"type",void 0),o([r({reflect:!0})],p.prototype,"width",void 0),o([r({type:Boolean,reflect:!0})],p.prototype,"paragraph",void 0),o([r({type:Number,reflect:!0})],p.prototype,"lineCount",void 0),p=o([a(`${n}-skeleton-text`)],p);export{c as S};
