...
import{i as t,p as e,x as s,_ as o,r as c}from"./settings-a9cb5e4b.js";import{n as a}from"./property-4de26c93.js";import{N as n,C as d,a as i}from"./content-switcher-item-12ae30b2.js";import{r}from"./state-225ff428.js";import{e as l}from"./query-602de8af.js";import{e as b}from"./class-map-e4ba9e2b.js";import{H as p,a as v}from"./host-listener-69c546a1.js";import{f as h}from"./collection-helpers-8b117611.js";import{s as g}from"./16-6a577b04.js";import{s as f}from"./16-fbe09c57.js";import{c as u}from"./carbon-element-017b212d.js";import"./if-defined-446d5754.js";import"./focus-969beaed.js";import"./directive-e2d48b9c.js";import"./on-8707857f.js";import"./spread-279bf949.js";
/**
 * @license
 *
 ...
 * This source code is licensed under the Apache-2.0 license found in the
 * LICENSE file in the root directory of this source tree.
 */let k=class extends(p(d)){constructor(){super(...arguments),this._currentIndex=0,this._totalTabs=0,this._isScrollable=!1,this.tablist=null,this.BUTTON_WIDTH=44,this._currentScrollPosition=0,this.selectingItemsAssistiveText="Selecting items. Use up and down arrow keys to navigate.",this.selectedItemAssistiveText="Selected an item.",this.triggerContent="",this.type=_.REGULAR,this._isIntersectionLeftTrackerInContent=!0,this._isIntersectionRightTrackerInContent=!0,this._observerIntersection=null,this._observeIntersectionContainer=t=>{const{_intersectionLeftSentinelNode:e,_intersectionRightSentinelNode:s}=this;t.forEach((({isIntersecting:t,target:o})=>{o===e&&(this._isIntersectionLeftTrackerInContent=t),o===s&&(this._isIntersectionRightTrackerInContent=t)}))}}_navigate(t,{immediate:e=!0}={}){const{selectorItem:s,selectorItemHighlighted:o,selectorItemSelected:c}=this.constructor,a=this._getNextItem(this.querySelector(e?c:o),t);if(!a)return;e?this._handleUserInitiatedSelectItem(a):h(this.querySelectorAll(s),(t=>{t[e?"selected":"highlighted"]=a===t})),a.scrollIntoView({block:"nearest",inline:"nearest"});const n=a.textContent;n&&(this._assistiveStatusText=n),this._currentIndex+=t,this.requestUpdate()}_handleClick(t){super._handleClick(t)}_handleKeydown(t){const{key:s}=t,o=this.constructor.getAction(s),c=this.querySelectorAll(`${e}-tab:not([disabled])`);switch(o){case m.HOME:{const[t]=c;t.scrollIntoView({block:"nearest",inline:"nearest"}),this._handleUserInitiatedSelectItem(t),this.requestUpdate()}break;case m.END:{const t=c[c.length-1];t.scrollIntoView({block:"nearest",inline:"nearest"}),this._handleUserInitiatedSelectItem(t),this.requestUpdate()}break;case m.NAVIGATING:{const t=n[s];t&&this._navigate(t)}}}_handleScrollButtonClick(t,{direction:e}){if(!this.tablist)return;const{scrollLeft:s,clientWidth:o,scrollWidth:c}=this._contentContainerNode;switch(e){case-1:this._contentContainerNode.scrollLeft=Math.max(s-c/this._totalTabs*1.5,0);break;case 1:this._contentContainerNode.scrollLeft=Math.min(s+c/this._totalTabs*1.5,c-o)+1}}_handleSlotchange(){const{selectorItemSelected:t}=this.constructor,e=this.querySelector(t);this._getNextItem(e,1).hideDivider=!0}_selectionDidChange(t){super._selectionDidChange(t),this._assistiveStatusText=this.selectedItemAssistiveText}_cleanAndCreateIntersectionObserverContainer({create:t}={}){const{_intersectionLeftSentinelNode:e,_intersectionRightSentinelNode:s}=this;this._observerIntersection&&(this._observerIntersection.disconnect(),this._observerIntersection=null),t&&(this._observerIntersection=new IntersectionObserver(this._observeIntersectionContainer,{root:this,threshold:0}),e&&this._observerIntersection.observe(e),s&&this._observerIntersection.observe(s))}disconnectedCallback(){this._cleanAndCreateIntersectionObserverContainer(),super.disconnectedCallback()}shouldUpdate(t){if(super.shouldUpdate(t),this.tablist){const{clientWidth:t,scrollWidth:e}=this.tablist;this._isScrollable=e>t}const{selectorItem:e}=this.constructor;return t.has("type")&&h(this.querySelectorAll(e),(t=>{this._totalTabs++,t.type=this.type})),!0}firstUpdated(){const{selectorTablist:t}=this.constructor,e=this.shadowRoot.querySelector(t);this.tablist=e,this._cleanAndCreateIntersectionObserverContainer({create:!0})}updated(t){var s,o;if(t.has("value")){const t=this.querySelector(`${e}-tab[value="${this.value}"]`);if(t){const{width:e}=null!==(s=null==t?void 0:t.getBoundingClientRect())&&void 0!==s?s:{},c=null!==(o=t.offsetLeft)&&void 0!==o?o:0,a=t.offsetLeft+e,n=this.tablist.scrollLeft+this.BUTTON_WIDTH,d=this.tablist.scrollLeft+this.tablist.clientWidth-this.BUTTON_WIDTH;c<n&&(this.tablist.scrollLeft=c-this.BUTTON_WIDTH),a>d&&(this.tablist.scrollLeft=a+this.BUTTON_WIDTH-this.tablist.clientWidth)}}t.has("_currentScrollPosition")&&this._contentNode&&(this._contentNode.style.insetInlineStart=`-${this._currentScrollPosition}px`)}renderPreviousButton(){const{_isIntersectionLeftTrackerInContent:t}=this,o=b({[`${e}--tab--overflow-nav-button`]:!0,[`${e}--tabs__nav-caret-left`]:!0,[`${e}--tab--overflow-nav-button--previous`]:!0,[`${e}--tab--overflow-nav-button--hidden`]:t});return s`
      <button
        part="prev-button"
        tabindex="-1"
        aria-hidden="true"
        class="${o}"
        @click=${t=>this._handleScrollButtonClick(t,{direction:n.Left})}>
        ${f()}
      </button>
    `}renderNextButton(){const{_isIntersectionRightTrackerInContent:t}=this,o=b({[`${e}--tab--overflow-nav-button`]:!0,[`${e}--tabs__nav-caret-right`]:!0,[`${e}--tab--overflow-nav-button--next`]:!0,[`${e}--tab--overflow-nav-button--hidden`]:t});return s`
      <button
        part="next-button"
        tabindex="-1"
        aria-hidden="true"
        class="${o}"
        @click=${t=>this._handleScrollButtonClick(t,{direction:n.Right})}>
        ${g()}
      </button>
    `}render(){const{_assistiveStatusText:t,_handleSlotchange:o}=this;return s`
      ${this.renderPreviousButton()}
      <div class="${e}--tabs-nav-content-container">
        <div class="${e}--tabs-nav-content">
          <div class="${e}--tabs-nav">
            <div id="tablist" role="tablist" class="${e}--tab--list">
              <div class="${e}--sub-content-left"></div>
              <slot @slotchange=${o}></slot>
              <div class="${e}--sub-content-right"></div>
            </div>
          </div>
        </div>
      </div>
      ...
      <div
        class="${e}--assistive-text"
        role="status"
        aria-live="assertive"
        aria-relevant="additions text">
        ${t}
      </div>
    `}static get selectorItem(){return`${e}-tab`}static get selectorItemEnabled(){return`${e}-tab:not([disabled])`}static get selectorItemHighlighted(){return`${e}-tab[highlighted]`}static get selectorItemSelected(){return`${e}-tab[selected]`}static get selectorTablist(){return`.${e}--tab--list`}static get eventBeforeSelect(){return`${e}-tabs-beingselected`}static get eventSelect(){return`${e}-tabs-selected`}static getAction(t){return"Home"===t?m.HOME:"End"===t?m.END:t in n?m.NAVIGATING:m.NONE}};k.TRIGGER_KEYS=new Set([" ","Enter"]),k.styles=y,o([v("click")],k.prototype,"_handleClick",null),o([v("keydown")],k.prototype,"_handleKeydown",null),o([l(`.${e}--tabs-nav-content-container`)],k.prototype,"_contentContainerNode",void 0),o([l(`.${e}--tabs-nav-content`)],k.prototype,"_contentNode",void 0),o([r()],k.prototype,"_currentScrollPosition",void 0),o([l(`.${e}--sub-content-left`)],k.prototype,"_intersectionLeftSentinelNode",void 0),o([l(`.${e}--sub-content-right`)],k.prototype,"_intersectionRightSentinelNode",void 0),o([a({attribute:"selecting-items-assistive-text"})],k.prototype,"selectingItemsAssistiveText",void 0),o([a({attribute:"selected-item-assistive-text"})],k.prototype,"selectedItemAssistiveText",void 0),o([a({attribute:"trigger-content"})],k.prototype,"triggerContent",void 0),o([a({reflect:!0})],k.prototype,"type",void 0),o([r()],k.prototype,"_isIntersectionLeftTrackerInContent",void 0),o([r()],k.prototype,"_isIntersectionRightTrackerInContent",void 0),k=o([u(`${e}-tabs`)],k);
/**
 * @license
 *
 * Copyright IBM Corp. 2019, 2024
 ...
 * LICENSE file in the root directory of this source tree.
 */
let x=class extends i{constructor(){super(...arguments),this.highlighted=!1,this.type=_.REGULAR}_handleSlotChange({target:t}){const e=t.assignedNodes();this.tabTitle=e[0].textContent}connectedCallback(){this.hasAttribute("role")||this.setAttribute("role","listitem"),super.connectedCallback()}render(){const{disabled:t,selected:o,tabTitle:c,_handleSlotChange:a}=this;return s`
      <a
        class="${e}--tabs__nav-link"
        role="tab"
        aria-label="${c}"
        tabindex="${o?0:-1}"
        ?disabled="${t}"
    ...
    `}};x.styles=y,o([a({type:Boolean,reflect:!0})],x.prototype,"highlighted",void 0),o([a({reflect:!0})],x.prototype,"type",void 0),o([a()],x.prototype,"tabTitle",void 0),x=o([u(`${e}-tab`)],x);
/**
 * @license
 *
 ...
 * LICENSE file in the root directory of this source tree.
 */
let z=class extends c{render(){return s` <div class="${e}--tabs__nav-link"></div> `}};z.styles=y,z=o([u(`${e}-tab-skeleton`)],z);
/**
 * @license
 *
 * Copyright IBM Corp. 2019, 2023
 ...
 * LICENSE file in the root directory of this source tree.
 */
let w=class extends c{render(){return s`
      <div class="${e}--tabs-trigger">
        <span class="${e}--tabs-trigger-text"></span>
      </div>
      <ul class="${e}--tabs__nav">
        <slot></slot>
      </ul>
    `}};w.styles=y,w=o([u(`${e}-tabs-skeleton`)],w);
