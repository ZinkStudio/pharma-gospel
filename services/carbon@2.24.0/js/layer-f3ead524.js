 ...
 * This source code is licensed under the Apache-2.0 license found in the
 * LICENSE file in the root directory of this source tree.
 */let v=class extends c{constructor(){super(...arguments),this.level=0}updated(){this.layers||(this.layers=this.querySelectorAll(this.constructor.selectorLayer)),this.layers.forEach((e=>{e.setAttribute("level",((this.level+1)%3).toString())})),this.dispatchEvent(new CustomEvent(this.constructor.eventUseLayer,{bubbles:!0,cancelable:!0,composed:!0,detail:{layer:this,level:this.level}}))}render(){return d` <slot></slot> `}static get selectorLayer(){return`${s}-layer`}static get eventUseLayer(){return`${s}-use-layer`}};v.styles=t,r([a({type:Number,reflect:!0})],v.prototype,"level",void 0),r([a()],v.prototype,"layers",void 0),v=r([l(`${s}-layer`)],v);
